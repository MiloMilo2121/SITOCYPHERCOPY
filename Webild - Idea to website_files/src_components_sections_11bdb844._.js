...
const FeatureCard = ({ feature, cardClassName = "", titleClassName = "", descriptionClassName = "", buttonClassName = "" })=>{
    _s();
...
_c = FeatureCard;
const FeatureCardTwentySix = ({ features, title, titleSegments, description, tag, tagIcon, tagAnimation = "opacity", buttons = [], buttonAnimation = "slide-up", textboxLayout, useInvertedBackground = false, ariaLabel = "Feature section", className = "", containerClassName = "", cardClassName = "", textBoxTitleClassName = "", textBoxTitleImageWrapperClassName = "", textBoxTitleImageClassName = "", textBoxDescriptionClassName = "", cardTitleClassName = "", cardDescriptionClassName = "", cardButtonClassName = "", carouselClassName = "", controlsClassName = "", textBoxClassName = "", textBoxTagClassName = "", textBoxButtonContainerClassName = "", textBoxButtonClassName = "", textBoxButtonTextClassName = "" })=>{
...
;
;
const FeatureCardSixteen = ({ negativeCard, positiveCard, animationType, title, titleSegments, description, textboxLayout, useInvertedBackground = false, tag, tagIcon, tagAnimation = "opacity", buttons = [], buttonAnimation = "slide-up", ariaLabel = "Feature comparison section", className = "", containerClassName = "", textBoxTitleClassName = "", titleImageWrapperClassName = "", titleImageClassName = "", textBoxDescriptionClassName = "", textBoxClassName = "", textBoxTagClassName = "", textBoxButtonContainerClassName = "", textBoxButtonClassName = "", textBoxButtonTextClassName = "", gridClassName = "", cardClassName = "", itemsListClassName = "", itemClassName = "", itemIconClassName = "", itemTextClassName = "" })=>{
    _s();
    const theme = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$providers$2f$themeProvider$2f$ThemeProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTheme"])();
    const shouldUseLightText = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shouldUseInvertedText"])(useInvertedBackground, theme.cardStyle);
    const { itemRefs, containerRef, perspectiveRef } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$cardStack$2f$hooks$2f$useCardAnimation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCardAnimation"])({
        animationType,
        itemCount: 2,
        isGrid: true,
...
;
;
const MetricCardItem = ({ metric, shouldUseLightText, cardClassName = "", valueClassName = "", titleClassName = "", descriptionClassName = "", iconContainerClassName = "", iconClassName = "" })=>{
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_c = MetricCardItem;
const MetricCardOne = ({ metrics, carouselMode = "buttons", gridVariant, uniformGridCustomHeightClasses, animationType, title, titleSegments, description, tag, tagIcon, tagAnimation = "opacity", buttons = [], buttonAnimation = "slide-up", textboxLayout, useInvertedBackground = false, ariaLabel = "Metrics section", className = "", containerClassName = "", cardClassName = "", textBoxTitleClassName = "", textBoxTitleImageWrapperClassName = "", textBoxTitleImageClassName = "", textBoxDescriptionClassName = "", valueClassName = "", titleClassName = "", descriptionClassName = "", iconContainerClassName = "", iconClassName = "", gridClassName = "", carouselClassName = "", controlsClassName = "", textBoxClassName = "", textBoxTagClassName = "", textBoxButtonContainerClassName = "", textBoxButtonClassName = "", textBoxButtonTextClassName = "" })=>{
    _s();
    const theme = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$providers$2f$themeProvider$2f$ThemeProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTheme"])();
    const shouldUseLightText = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shouldUseInvertedText"])(useInvertedBackground, theme.cardStyle);
...
;
;
const TeamCardFive = ({ team, animationType, title, titleSegments, description, textboxLayout, useInvertedBackground = false, tag, tagIcon, tagAnimation = "opacity", buttons = [], buttonAnimation = "slide-up", ariaLabel = "Team section", className = "", containerClassName = "", textBoxTitleClassName = "", textBoxTitleImageWrapperClassName = "", textBoxTitleImageClassName = "", textBoxDescriptionClassName = "", textBoxClassName = "", textBoxTagClassName = "", textBoxButtonContainerClassName = "", textBoxButtonClassName = "", textBoxButtonTextClassName = "", gridClassName = "", cardClassName = "", mediaWrapperClassName = "", mediaClassName = "", nameClassName = "", roleClassName = "" })=>{
    _s();
    const { itemRefs } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$cardStack$2f$hooks$2f$useCardAnimation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCardAnimation"])({
        animationType,
...
;
;
const FaqBase = ({ faqs, title, titleSegments, description, tag, tagIcon, tagAnimation = "opacity", buttons = [], buttonAnimation = "slide-up", faqsAnimation, textboxLayout, useInvertedBackground = false, animationType = "smooth", showCard = true, ariaLabel = "FAQ section", className = "", containerClassName = "", textBoxTitleClassName = "", titleImageWrapperClassName = "", titleImageClassName = "", textBoxDescriptionClassName = "", textBoxClassName = "", textBoxTagClassName = "", textBoxButtonContainerClassName = "", textBoxButtonClassName = "", textBoxButtonTextClassName = "", faqsContainerClassName = "", accordionClassName = "", accordionTitleClassName = "", accordionIconContainerClassName = "", accordionIconClassName = "", accordionContentClassName = "", separatorClassName = "" })=>{
    _s();
    ...
    const { containerRef: faqsContainerRef } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$hooks$2f$useButtonAnimation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useButtonAnimation"])({
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: faqs.map((faq, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            children: [
                                ...
                                !showCard && index < faqs.length - 1 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
;
;
const ContactCTA = ({ tag, tagIcon, tagAnimation = "opacity", title, description, buttons = [], buttonAnimation = "slide-up", background, useInvertedBackground = false, ariaLabel = "Contact section", className = "", containerClassName = "", contentClassName = "", textBoxClassName = "", titleClassName = "", descriptionClassName = "", tagClassName = "", buttonContainerClassName = "", buttonClassName = "", buttonTextClassName = "" })=>{
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
        "aria-label": ariaLabel,
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cls"])("relative py-20 w-full", useInvertedBackground && "bg-foreground", className),
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
;
;
const FooterBase = ({ logoSrc, logoAlt = "", logoText, columns, copyrightText = `© 2025 | Webild`, onPrivacyClick, ariaLabel = "Site footer", className = "", containerClassName = "", logoClassName = "", logoImageClassName = "", logoTextClassName = "", columnsClassName = "", columnClassName = "", columnTitleClassName = "", columnItemClassName = "", copyrightContainerClassName = "", copyrightTextClassName = "", privacyButtonClassName = "" })=>{
...
;
;
const TestimonialCardFifteen = ({ testimonial, rating, author, avatars, ratingAnimation, avatarsAnimation, useInvertedBackground = false, ariaLabel = "Testimonial section", className = "", containerClassName = "", ratingClassName = "", starClassName = "", testimonialClassName = "", avatarGroupClassName = "", avatarClassName = "", avatarImageClassName = "" })=>{
    _s();
    const theme = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$providers$2f$themeProvider$2f$ThemeProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTheme"])();
    const { containerRef: ratingContainerRef } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$hooks$2f$useButtonAnimation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useButtonAnimation"])({
