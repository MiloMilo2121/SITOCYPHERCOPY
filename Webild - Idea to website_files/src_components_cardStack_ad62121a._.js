...
const useDepth3DAnimation = ({ itemRefs, containerRef, perspectiveRef, isEnabled })=>{
    _s();
...
;
const useCardAnimation = ({ animationType, itemCount, isGrid = true, supports3DAnimation = false, gridVariant, useIndividualTriggers = false })=>{
    _s();
    ...
    const { isMobile } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$cardStack$2f$hooks$2f$useDepth3DAnimation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDepth3DAnimation"])({
        itemRefs,
        containerRef,
        perspectiveRef,
...
const GridLayout = ({ children, itemCount, gridVariant = "uniform-all-items-equal", uniformGridCustomHeightClasses, gridRowsClassName, itemHeightClassesOverride, animationType, supports3DAnimation = false, title, titleSegments, description, tag, tagIcon, tagAnimation, buttons, buttonAnimation, textboxLayout = "default", useInvertedBackground, bottomContent, className = "", containerClassName = "", gridClassName = "", textBoxClassName = "", titleClassName = "", titleImageWrapperClassName = "", titleImageClassName = "", descriptionClassName = "", tagClassName = "", buttonContainerClassName = "", buttonClassName = "", buttonTextClassName = "", ariaLabel })=>{
    ...
    const { itemRefs, containerRef, perspectiveRef, bottomContentRef } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$cardStack$2f$hooks$2f$useCardAnimation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCardAnimation"])({
        animationType,
...
const ButtonCarousel = ({ children, uniformGridCustomHeightClasses, animationType, title, titleSegments, description, tag, tagIcon, tagAnimation, buttons, buttonAnimation, textboxLayout = "default", useInvertedBackground, bottomContent, className = "", containerClassName = "", carouselClassName = "", carouselItemClassName = "", controlsClassName = "", textBoxClassName = "", titleClassName = "", titleImageWrapperClassName = "", titleImageClassName = "", descriptionClassName = "", tagClassName = "", buttonContainerClassName = "", buttonClassName = "", buttonTextClassName = "", ariaLabel })=>{
    ...
    const { prevBtnDisabled, nextBtnDisabled, onPrevButtonClick, onNextButtonClick } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$cardStack$2f$hooks$2f$usePrevNextButtons$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePrevNextButtons"])(emblaApi);
