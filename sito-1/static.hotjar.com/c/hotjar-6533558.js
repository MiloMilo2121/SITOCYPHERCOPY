window.hjSiteSettings = window.hjSiteSettings || {
    "site_id": 6533558,
    "rec_value": 0.00026214399986201897,
...
! function() {
    ...
    var o, s = function() {
        ...
        l = function(e, t, n) {
            var r;
            c.loggedMetrics[e] = a(a({}, c.loggedMetrics[e]), {}, ((r = {})[t] = n || {}, r))
        },
        d = function(e) {
            if (!e) return "value";
        ...
        p = {
            ...
            count: function(e, t) {
                ...
                try {
                    var u, l = d(r),
                        h = c.loggedMetrics[e],
                        p = 0;
                    if (n ? (p = (h && h[l] || 0) + (n.value || 1), c.loggedMetrics[e] = a(a({}, h), {}, ((u = {})[l] = null != n && n.flush ? 0 : p, u))) : p = 1, f(s, n)) {
                        var v = {
                            name: e,
                            type: "count",
                            value: p,
            ...
            timeWatcher: function() {
                var e, t = 0,
                    ...
                    r = function() {
                        var n, r = p.time();
                        return t += null !== (n = e && r && r - e) && void 0 !== n ? n : 0, e = p.time(), t
                    };
                return {
                    start: function() {
    ...
    var O, x = function() {
        ...
        if (i) {
            ...
            a.type = "text/javascript", a.async = !0, a.src = "//".concat(r, "/uxa/").concat(i, ".js"), document.getElementsByTagName("head")[0].appendChild(a)
        }
    };
    ...
    function C() {
        ...
        }, window.hj.metrics = p, hj.metrics.start();
        var r, i, a, o, s, u, c, l, d, g, f, h, w = !(!window.CS_CONF || null === (e = window.CS_CONF.voc) || void 0 === e || !e.enabled),
            b = !(window.CS_CONF || null === (t = window.hjSiteSettings) || void 0 === t || null === (n = t.features) || void 0 === n || !n.includes("cs_lite"));
        if (w && window._uxa) window._uxa.push(["start:hotjar", hjSiteSettings]), window.hj.scriptLoaded = !0;
        else if (b) {
            var y = (u = (r = hjSiteSettings).suppress_all || r.suppress_text || (null === (i = r.suppress_all_on_specific_pages) || void 0 === i ? void 0 : i.length), c = function(e) {
                    ...
                    if ((e.suppress_all || e.suppress_text) && (o.anonymisationMethod = v.replayRecordingMaskedUrlRegex, o.replayRecordingMaskedUrlRegex = ".*"), null !== (t = e.suppress_all_on_specific_pages) && void 0 !== t && t.length) {
                        ...
                        var s = (n = e.suppress_all_on_specific_pages, r = {
                            ...
                            exact: m.EXACT,
                            starts_with: m.START
                        }, i = [], a = Object.keys(r), n.forEach((function(e) {
                    ...
                    return o
                }(r), l = c.anonymisationMethod, d = c.replayRecordingMaskedUrlRegex, g = c.replayRecordingMaskedUrlRegexRules, f = !(null === (a = _hjSettings) || void 0 === a || !a.environment || "live" === _hjSettings.environment), {
                    CS_CONF_BASE: {
                        ...
                        smbConfig: {
                            ...
                            useCSTC: !0,
                            useSentry: !0,
                            csLiteDomain: f ? "insights-integration.live.eks.hotjar.com" : "insights.hotjar.com"
                        },
                        hostnames: [window.location.hostname],
                        voc: null !== (o = r.polls) && void 0 !== o && o.length || T() ? {
                            enabled: 1,
                            siteId: r.site_id
                        } : {
                            enabled: 0
                        ...
                        implementations: (s = r, R(E, (h = s.state_change_listen_mode, "manual" === h ? [] : [{
                            template: {
            ...
            var r, i, a = new RegExp("bot|google|headless|baidu|bing|msn|duckduckbot|teoma|slurp|yandex|phantomjs|pingdom|ahrefsbot|facebook", "i"),
                o = (null === (r = window.navigator) || void 0 === r ? void 0 : r.userAgent) || "unknown";
            ...
            window.hjBootstrap = function(e, t, n) {
                var r;
                window.hjBootstrapCalled = (window.hjBootstrapCalled || []).concat(n), window.hj && window.hj._init && (null === (r = hj._init) || void 0 === r || r._verifyInstallation())
            }, window.hjBootstrap(e, t, n), window.hjBootstrap.revision = "9284c1a";
            var c = window.document,
                l = c.head || c.getElementsByTagName("head")[0];
            hj.scriptDomain = e;
            var d = c.createElement("script");
            d.async = !0, d.src = hj.scriptDomain + t, d.charset = "utf-8", l.appendChild(d)
        }, window.hjBootstrap("https://script.hotjar.com/", "modules.c3d712579ef0b1b5af2a.js", "6533558")
    }
    window.hjLazyModules = window.hjLazyModules || {
        SURVEY_V2: {
            js: "survey-v2.e32cd7dab64020ce88f7.js"
        },
        SURVEY_BOOTSTRAPPER: {
        ...
        SURVEY_INVITATION: {
            js: "survey-invitation.4661cf35c8e690746c30.js"
        },
        NOTIFICATION: {
        ...
        USER_TEST: {
            js: "user-test.9f4a4a23af9d178c86d9.js"
        }
    };
    var I = null !== (O = hjSiteSettings.features) && void 0 !== O ? O : [];
    I.indexOf("one_app_tag") > -1 ? x() : I.indexOf("one_app_tag_dc") > -1 ? (x(), window.addEventListener("csq:start-hotjar", (function() {
        C()
    }))) : C()
}();