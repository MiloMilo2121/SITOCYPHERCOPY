(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
    typeof document === "object" ? document.currentScript : undefined,
    {
        ...
        "runtimeModuleIds": ["[project]/node_modules/next/dist/compiled/@next/react-refresh-utils/dist/runtime.js [app-client] (ecmascript)", "[project]/node_modules/next/dist/client/app-next-turbopack.js [app-client] (ecmascript)"]
    }
]);
(() => {
    ...
    function interopEsm(raw, ns, allowExportDefault) {
        ...
        for (let current = raw;
            (typeof current === 'object' || typeof current === 'function') && !LEAF_PROTOTYPES.includes(current); current = getProto(current)) {
...
importScripts(...self.TURBOPACK_NEXT_CHUNK_URLS.map(c => self.TURBOPACK_WORKER_LOCATION + c).reverse());`;
    ...
    function applyPhase(outdatedSelfAcceptedModules, newModuleFactories, outdatedModuleParents, reportError) {
        ...
        for (const {
                moduleId,
                errorHandler
            } of outdatedSelfAcceptedModules) {
            try {
    ...
    function applyEcmascriptMergedUpdate(update) {
        ...
        const {
            outdatedModules,
            newModuleFactories
        } = computeOutdatedModules(added, modified);
        const {
            disposedModules
        } = updateChunksPhase(chunksAdded, chunksDeleted);
    ...
    (() => {
        BACKEND = {
            ...
            async loadWebAssembly(_sourceType, _sourceData, wasmChunkPath, _edgeModule, importsObj) {
                ...
                const {
                    instance
                } = await WebAssembly.instantiateStreaming(req, importsObj);
