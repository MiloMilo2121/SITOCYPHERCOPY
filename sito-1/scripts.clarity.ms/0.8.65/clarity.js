/* clarity-js v0.8.65: https://github.com/microsoft/clarity (License: MIT) */ ! function() {
    "use strict";
    ...
    function Qn() {
        ...
        p = {
            gap: t - g
        }, Wr(25), p.gap < 3e5 ? m = Gn(Qn, v) : cn && (Fn("clarity", "suspend"), Mo(), ["mousemove", "touchstart"].forEach((function(t) {
    ...
    function ci(t, e, n) {
        void 0 === t.__clr[e] && (t.__clr[e] = t.CSSStyleSheet.prototype[e], t.CSSStyleSheet.prototype[e] = function() {
            return yo() && bt.includes(this[gt]) && fi(Cn(), this[gt], n, arguments[0]), t.__clr[e].apply(this, arguments)
        })
    }
    ...
    function si(t, e) {
        ...
        if ((!xn.lean || !xn.lite) && (yt.includes(t) || (yt.push(t), t.defaultView && ui(t.defaultView)), e = e || Cn(), null == t ? void 0 : t.adoptedStyleSheets)) {
            for (n = [], a = 0, i = t.adoptedStyleSheets; a < i.length; a++)(r = i[a])[gt] && bt.includes(r[gt]) || (r[gt] = no(), bt.push(r[gt]), fi(e, r[gt], 0), fi(e, r[gt], 2, Wi(r))), n.push(r[gt]);
    ...
    function vi(t, e) {
        var n, a, i, r, o;
        if (yo() && null !== (a = (null == (n = t.effect) ? void 0 : n.target) ? Fi(n.target) : null) && n.getKeyframes && n.getTiming && (t[Et] || (t[Et] = no(), t[Tt] = 0, i = n.getKeyframes(), r = n.getTiming(), pi(Cn(), t[Et], 0, JSON.stringify(i), JSON.stringify(r), a)), t[Tt]++ < Nt)) {
            switch (o = null, e) {
                case "play":
                    o = 1;
                    break;
    ...
    function ji(t) {
        tr(t) || fo(t) || (function(t) {
            ...
            ! function(t) {
                ...
                co(t, "click", Ea.bind(this, 9, t), !0), co(t, "contextmenu", Ea.bind(this, 48, t), !0)
            }(t), function(t) {
                co(t, "cut", xa.bind(this, 0), !0), co(t, "copy", xa.bind(this, 1), !0), co(t, "paste", xa.bind(this, 2), !0)
            }(t), function(t) {
                co(t, "mousedown", Ra.bind(this, 13, t), !0), co(t, "mouseup", Ra.bind(this, 14, t), !0), co(t, "mousemove", Ra.bind(this, 12, t), !0), co(t, "wheel", Ra.bind(this, 15, t), !0), co(t, "dblclick", Ra.bind(this, 16, t), !0), co(t, "touchstart", La.bind(this, 17, t), !0), co(t, "touchend", La.bind(this, 18, t), !0), co(t, "touchmove", La.bind(this, 19, t), !0), co(t, "touchcancel", La.bind(this, 20, t), !0)
            }(t), function(t) {
                co(t, "input", Da, !0), co(t, "keydown", Ca, !0)
            }(t), function(t) {
                co(t, "selectstart", Ja.bind(this, t), !0), co(t, "selectionchange", Ja.bind(this, t), !0)
            }(t), function(t) {
                co(t, "change", wa, !0)
            }(t), function(t) {
                co(t, "submit", Za, !0)
    ...
    function Xi(t) {
        ...
        var e, n, a, i = (a = t, (ae.has(a) ? ae.get(a) : null) || {}),
            ...
            u = i.win,
            c = void 0 === u ? null : u;
        c && so(c), o && (so(o), e = o, (n = Yt.get(e)) && (n.disconnect(), xt.delete(n), Yt.delete(e)), function(t, e) {
    ...
    function Xr(t) {
        yo() && xn.lean && (xn.lean = !1, He = {
            key: t
        }, $r(), to(), xn.upgrade && xn.upgrade(t), Wr(3), xn.lite && (Yr(), li()))
    }
    ...
    function Kr(t, e) {
        ...
        if (void 0 === t && (t = $e), void 0 === e && (e = 5), yo()) {
            ...
            if (Ze = a, $r(!0), !(i = Gr(Ze)).analytics_Storage && xn.track) return xn.track = !1, Qr(!0), Mo(), void window.setTimeout(No, 250);
            yo() && i.analytics_Storage && (xn.track = !0, eo(io(), 1), to()), Br(), Vr(i), zr()
        }
    }
    ...
    function io() {
        ...
        return n && n.length > 0 && ((t = n.includes("^") ? n.split("^") : n.split("|")).length > 1 && (e.version = ao(t[1])), t.length > 2 && (e.expiry = ao(t[2], 36)), t.length > 3 && 1 === ao(t[3]) && (e.consent = 1), t.length > 4 && ao(t[1]) > 1 && (e.dob = ao(t[4])), xn.track = xn.track || 1 === e.consent, e.id = xn.track ? t[0] : e.id), e
    }
    ...
    function po(t, e) {
        if (null === t) try {
            t = history[e], history[e] = function() {
                t.apply(this, arguments), yo() && (!(un++ > 20) || (_r(4, 0), 0)) && go()
            }
        } catch (e) {
            t = null
        }
        ...
        ln = {
            ...
            function(t) {
                $n(this, void 0, void 0, (function() {
                    var t, e;
                    return ta(this, (function(n) {
                        return t = Cn(), (e = [t, 29]).push(ln.fetchStart, ln.connectStart, ln.connectEnd, ln.requestStart, ln.responseStart, ln.responseEnd, ln.domInteractive, ln.domComplete, ln.loadEventStart, ln.loadEventEnd, ln.redirectCount, ln.size, ln.type, ln.protocol, ln.encodedSize, ln.decodedSize), wo(), wr(e), [2]
                    }))
                }))
            }()
    }
    ...
    function So() {
        var t, e, n;
        try {
            for (Sn && Sn.disconnect(), Sn = new PerformanceObserver(uo(Eo)), t = 0, e = En; t < e.length; t++) n = e[t], PerformanceObserver.supportedEntryTypes.includes(n) && ("layout-shift" === n && Jn(9, 0), Sn.observe({
                type: n,
                buffered: !0
            }))
        } catch (t) {
        ...
        ! function(t) {
            ...
            for ((e = !("visibilityState" in document) || "visible" === document.visibilityState, n = 0); n < t.length; n++) switch ((a = t[n]).entryType) {
                case "navigation":
                    ...
                    break;
                case "resource":
                    qr(4, To(i = a.name)), i !== xn.upload && i !== xn.fallback || Kn(28, a.duration);
                    break;
                case "longtask":
                    Bn(7);
                    break;
    ...
    function No(e) {
        void 0 === e && (e = null),
            ...
            }(e), cn = !0, t = Dn(), Or(), lo(), ro(), on = mo(), un = 0, co(window, "popstate", go), an = po(an, "pushState"), rn = po(rn, "replaceState"), f = {}, h = {}, Bn(5), I.forEach((function(t) {
                return uo(t.start)()
    ...
    function Mo() {
        yo() && (Nn.slice().reverse().forEach((function(t) {
            ...
            return uo(t.stop)()
        })), f = {}, h = {}, on = null, un = 0, ro(), lo(), Or(), t = 0, cn = !1, void 0 !== _n && (_n[On] = function() {
            (_n[On].q = _n[On].q || []).push(arguments), "start" === arguments[0] && _n[On].q.unshift(_n[On].q.pop()) && _o()
        }))
    }
    ...
    t = 0, e = "0.8.65", n = /\S/gi, a = 2048, i = !0, r = null, o = null, u = null, c = null, l = null, s = !1, d = null, f = null, h = null, g = 0, v = 0, m = null, y = null, b = "CompressionStream" in window, w = null, k = {}, S = new Set, E = {}, T = {}, N = {}, M = {}, _ = null, O = "^", x = null, I = [{
        start: function() {
            s = !1, Hn()
        },
        stop: function() {
        ...
        start: function() {
            ...
            Ge = f.indexOf("Electron") > 0 ? 1 : 0, l = {
                ...
                upgrade: null,
                upload: ""
            }, (s = va("_clsk", !xn.includeSubdomains)) && (c = s.includes("^") ? s.split("^") : s.split("|")).length >= 5 && l.ts - ao(c[1]) < 18e5 && (l.session = c[0], l.count = ao(c[2]) + 1, l.upgrade = ao(c[3]), l.upload = c.length >= 6 ? "https://" + c[5] + "/" + c[4] : "https://" + c[4]), a = l, i = io(), r = xn.projectId || An(location.host), Je = {
                projectId: r,
                userId: i.id,
                sessionId: a.session,
                pageNum: a.count
            }, xn.lean = xn.track && null !== a.upgrade ? 0 === a.upgrade : xn.lean, xn.upload = xn.track && "string" == typeof xn.upload && a.upload && a.upload.length > "https://".length ? a.upload : xn.upload, qr(0, f), qr(3, v), qr(1, Rn(location.href, !!Ge)), qr(2, document.referrer), qr(15, function() {
                var t = no();
                return xn.track && pa(window, "sessionStorage") && (t = sessionStorage.getItem("_cltk") || t, sessionStorage.setItem("_cltk", t)), t
            }()), qr(16, document.documentElement.lang), qr(17, document.dir), qr(26, "" + window.devicePixelRatio), qr(28, "" + i.dob), qr(29, "" + i.version), qr(33, g), qr(34, h), qr(35, p), qr(38, "" + !(!navigator || !navigator.globalPrivacyControl)), Kn(0, a.ts), Kn(1, 0), Kn(35, Ge), (o = null === window || void 0 === window ? void 0 : window.Zone) && "__symbol__" in o && Kn(39, 1), navigator && (qr(9, navigator.language), Kn(33, navigator.hardwareConcurrency), Kn(32, navigator.maxTouchPoints), Kn(34, Math.round(navigator.deviceMemory)), (u = navigator.userAgentData) && u.getHighEntropyValues ? u.getHighEntropyValues(["model", "platform", "platformVersion", "uaFullVersion"]).then((function(t) {
                var e;
            ...
            }), Br(), Fr((d = Gr(Ze)).analytics_Storage ? 1 : 0), Ve = d, eo(i)
        },
        stop: function() {
        ...
        start: function() {
            Si(), Ei(), sr(), de = null, ue = new WeakMap, ce = {}, le = [], se = !!window.IntersectionObserver, Ui(), zi(document, !0), xn.delayDom ? co(window, "load", (function() {
                    Ni()
                })) : Ni(),
                function() {
                    var t;
                    try {
                        window.__clr = window.__clr || {}, (null === (t = window.customElements) || void 0 === t ? void 0 : t.define) && !window.__clr.define && (window.__clr.define = window.customElements.define, window.customElements.define = function() {
                            return yo() && mi(arguments[0]), window.__clr.define.apply(this, arguments)
                        })
                    } catch (t) {}
                }(), Yr(), li(),
                function() {
        ...
        start: function() {
            fe = [], pr(), Oa(), Ia(), Xa(), Pa(), Q = !1, co(window, "resize", $), Ha(), co(document, "visibilitychange", ei), ei(), co(window, "focus", (function() {
                    return ii(1)
                ...
                }(), tt = [], za(), Ga(), ka(), Qa(), co(window, "pagehide", $a)
        },
        stop: function() {
        ...
        start: function() {
            wo(),
                function() {
                    navigator && navigator.connection && qr(27, navigator.connection.effectiveType), window.PerformanceObserver && PerformanceObserver.supportedEntryTypes ? "complete" !== document.readyState ? co(window, "load", Gn.bind(this, So, 0)) : So() : _r(3, 0)
                }()
        },
        stop: function() {
        ...
        pause: function() {
            yo() && (Fn("clarity", "pause"), null === je && (je = new Promise((function(t) {
                Xe = t
            }))))
        },
        queue: wr,
        ...
        resume: function() {
            yo() && (je && (Xe(), je = null, null === Ye && Ir()), Fn("clarity", "resume"))
        },
        schedule: xr,
        set: na,
        signal: function(t) {
