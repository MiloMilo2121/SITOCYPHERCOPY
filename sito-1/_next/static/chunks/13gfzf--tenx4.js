(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 2933, (e, t, n) => {
    e.e, t.exports = (() => {
        ...
        var e, t, n, r, i, a, o, s, u, l, c, h, f, d, p, v, m, b, g, y, w, _, A, C, M, P, R, E, I, k, F, T, L, O, x, j, S, V, D, B, W, U, N, z, $, H, Y, X, G, q, J, K, Z, Q, ee, et, en, er, ei, ea, eo, es, eu, el, ec = [, (e, t, n) => {
                ...
                var r = n(4),
                    ...
                    o = function() {
                        ...
                        return e.loadRuntime = function() {
                            var t = e.wasmURL,
                                n = e.wasmBinary;
                            e.enablePerfMarks && performance.mark("rive:wasm-init:start"), r.default(a({
                                locateFile: function() {
                                    return t
                                }
                            }, n ? {
                                ...
                                var n;
                                for (e.enablePerfMarks && (performance.mark("rive:wasm-init:end"), performance.measure("rive:wasm-init", "rive:wasm-init:start", "rive:wasm-init:end")), e.runtime = t; e.callBackQueue.length > 0;) null == (n = e.callBackQueue.shift()) || n(e.runtime)
                            }).catch(function(n) {
                                var r = {
                                ...
                                } else console.warn("Failed to load WASM from ".concat(t, " (").concat(r.message, "), trying fallback URL: ").concat(i)), e.wasmBinary = null, e.setWasmUrl(i), e.loadRuntime()
                            })
                            ...
                            return e.wasmBinary
                        }, e.isLoading = !1, e.callBackQueue = [], e.wasmURL = "https://unpkg.com/".concat(i.name, "@").concat(i.version, "/rive.wasm"), e.wasmFallbackURL = "https://cdn.jsdelivr.net/npm/".concat(i.name, "@").concat(i.version, "/rive_fallback.wasm"), e.wasmBinary = null, e.enablePerfMarks = !1, e
                    }()
            }, (e, t, n) => {
                var r;
                n.r(t), n.d(t, {
                ...
                let i = (r = "u" > typeof document ? document.currentScript ? .src : void 0, function(e = {}) {
                            ...
                            function e() {
                                if (!t) {
                                    ...
                                    if (/iPhone|iPad|iPod/i.test(navigator.userAgent)) {
                                        if (l = e.getContext("webgl", o), n = 1, !l) return console.log("No WebGL support. Image mesh will not be drawn."), !1
                                    } else if (l = e.getContext("webgl2", o)) n = 2;
                                    else {
                                        if (!(l = e.getContext("webgl", o))) return console.log("No WebGL support. Image mesh will not be drawn."), !1;
                                        n = 1
                                    }
                                    ...
                                    if (r = Math.min((l = new Proxy(l, {
                                            get: (e, t) => e.isContextLost() ? (u || (console.error("Cannot render the mesh because the GL Context was lost. Tried to invoke ", t), u = !0), "function" == typeof e[t]) ? function() {} : void 0 : "function" == typeof e[t] ? function(...n) {
                                                return e[t].apply(e, n)
                                            } : e[t],
                                            set(e, t, n) {
                                                if (!e.isContextLost()) return e[t] = n, !0;
                                                u || (console.error("Cannot render the mesh because the GL Context was lost. Tried to set property " + t), u = !0)
                                            }
                                        })).getParameter(l.MAX_RENDERBUFFER_SIZE), l.getParameter(l.MAX_TEXTURE_SIZE)), s(e = l.createProgram(), l.VERTEX_SHADER, "attribute vec2 vertex;\n                attribute vec2 uv;\n                uniform vec4 mat;\n                uniform vec2 translate;\n                varying vec2 st;\n                void main() {\n                    st = uv;\n                    gl_Position = vec4(mat2(mat) * vertex + translate, 0, 1);\n                }"), s(e, l.FRAGMENT_SHADER, "precision highp float;\n                uniform sampler2D image;\n                varying vec2 st;\n                void main() {\n                    gl_FragColor = texture2D(image, st);\n                }"), l.bindAttribLocation(e, 0, "vertex"), l.bindAttribLocation(e, 1, "uv"), l.linkProgram(e), 0 < ((o = l.getProgramInfoLog(e)) || "").trim().length) throw o;
                                    i = l.getUniformLocation(e, "mat"), a = l.getUniformLocation(e, "translate"), l.useProgram(e), l.bindBuffer(l.ARRAY_BUFFER, l.createBuffer()), l.enableVertexAttribArray(0), l.enableVertexAttribArray(1), l.bindBuffer(l.ELEMENT_ARRAY_BUFFER, l.createBuffer()), l.uniform1i(l.getUniformLocation(e, "image"), 0), l.pixelStorei(l.UNPACK_PREMULTIPLY_ALPHA_WEBGL, !0), t = l
                                }
                                return !0
                            }
                            let t = null,
                            ...
                            this.Nb = function(n, r, u, d, p) {
                                if (e()) {
                                    var v = l.push(n),
                                        m = c.push(r);
                                    if (t.canvas) {
                                        for (var b of ((t.canvas.width != v || t.canvas.height != m) && (t.canvas.width = v, t.canvas.height = m), t.viewport(0, m - r, n, r), t.disable(t.SCISSOR_TEST), t.clearColor(0, 0, 0, 0), t.clear(t.COLOR_BUFFER_BIT), t.enable(t.SCISSOR_TEST), u.sort((e, t) => t.vb - e.vb), v = h.push(d), o != v && (t.bufferData(t.ARRAY_BUFFER, 8 * v, t.DYNAMIC_DRAW), o = v), v = 0, u)) t.bufferSubData(t.ARRAY_BUFFER, v, b.Ta), v += 4 * b.Ta.length;
                                        for (var g of (console.assert(v == 4 * d), u)) t.bufferSubData(t.ARRAY_BUFFER, v, g.Bb), v += 4 * g.Bb.length;
                                        for (var y of (console.assert(v == 8 * d), v = f.push(p), s != v && (t.bufferData(t.ELEMENT_ARRAY_BUFFER, 2 * v, t.DYNAMIC_DRAW), s = v), b = 0, u)) t.bufferSubData(t.ELEMENT_ARRAY_BUFFER, b, y.indices), b += 2 * y.indices.length;
                                        for (let e of (console.assert(b == 2 * p), y = 0, g = !0, v = b = 0, u)) {
                                            e.image.Ja != y && (t.bindTexture(t.TEXTURE_2D, e.image.Ia || null), y = e.image.Ja), e.hc ? (t.scissor(e.Za, m - e.$a - e.jb, e.uc, e.jb), g = !0) : g && (t.scissor(0, m - r, n, r), g = !1), u = 2 / n;
                                            let o = -2 / r;
                                            t.uniform4f(i, e.ha[0] * u * e.Aa, e.ha[1] * o * e.Ba, e.ha[2] * u * e.Aa, e.ha[3] * o * e.Ba), t.uniform2f(a, e.ha[4] * u * e.Aa + u * (e.Za - e.cc * e.Aa) - 1, e.ha[5] * o * e.Ba + o * (e.$a - e.dc * e.Ba) + 1), t.vertexAttribPointer(0, 2, t.FLOAT, !1, 0, v), t.vertexAttribPointer(1, 2, t.FLOAT, !1, 0, v + 4 * d), t.drawElements(t.TRIANGLES, e.indices.length, t.UNSIGNED_SHORT, b), v += 4 * e.Ta.length, b += 2 * e.indices.length
                                        }
                                        console.assert(v == 4 * d), console.assert(b == 2 * p)
                                    }
                                }
                    ...
                    e.onRuntimeInitialized = function() {
                        ...
                        function r() {
                            for (let e of (0 < M.length && (m.Nb(C.drawWidth(), C.drawHeight(), M, P, R), M = [], R = P = 0, C.reset(512, 512)), A)) {
                                for (let t of e.I) t();
                                e.I = []
                            }
                            A.clear()
                        ...
                        var y = e.RenderImage.extend("CanvasRenderImage", {
                                __construct: function({
                                    ...
                                    this.__parent.__construct.call(this), this.Ja = g, g = g + 1 & 0x7fffffff || 1, this.la = e, this.wa = t
                                },
                                __destruct: function() {
                                    this.Ia && (m.Kb(this.Ia), URL.revokeObjectURL(this.Wa)), this.__parent.__destruct.call(this)
                                },
                                decode: function(e) {
                                    var t = this;
                                    t.wa && t.wa(t);
                                    ...
                                    t.Wa = URL.createObjectURL(new Blob([e], {
                                        ...
                                        t.Db = n, t.Ia = m.Jb(n), t.size(n.width, n.height), t.la && t.la(t)
                                    }, n.src = t.Wa
                                }
                            }),
                            w = a.extend("CanvasRenderPath", {
                                __construct: function() {
                                    this.__parent.__construct.call(this), this.U = new Path2D
                                },
                                rewind: function() {
                                    this.U = new Path2D
                                },
                                addPath: function(e, t, n, r, i, a, o) {
                                    ...
                                    e = e.U;
                                    let l = new DOMMatrix;
                                    l.a = t, l.b = n, l.c = r, l.d = i, l.e = a, l.f = o, u.call(s, e, l)
                                },
                                fillRule: function(e) {
                                    this.Va = e
                                },
                            ...
                            _ = o.extend("CanvasRenderPaint", {
                                ...
                                draw: function(e, t, r, i) {
                                    ...
                                    let u = e.globalCompositeOperation,
                                        l = e.globalAlpha;
                                    if (e.globalCompositeOperation = this.Cb, e.globalAlpha = i, null != s) {
                                        o = s.xb;
                                        let t = s.yb,
                                            r = s.cb;
                                        var c = s.eb;
                                        i = s.Qa, s.ac ? (s = r - o, c -= t, o = e.createRadialGradient(o, t, 0, o, t, Math.sqrt(s * s + c * c))) : o = e.createLinearGradient(o, t, r, c);
                                        for (let e = 0, t = i.length; e < t; e++) s = i[e], o.addColorStop(s.stop, n(s.color));
                                        this.Xa = o, this.ja = null
                                    }
                                    switch (a) {
                                        case d:
                                            e.strokeStyle = o, e.lineWidth = this.Gb, e.lineCap = this.Ga, e.lineJoin = this.Ha, e.stroke(t);
                                            break;
                                        case h:
                                            e.fillStyle = o, e.fill(t, r)
                                    }
                                    e.globalCompositeOperation = u, e.globalAlpha = l
                                }
                            });
                        let A = new Set,
                            C = null,
                        ...
                        var E = e.CanvasRenderer = s.extend("Renderer", {
                            __construct: function(e) {
                                this.__parent.__construct.call(this), this.T = [1, 0, 0, 1, 0, 0], this.G = [1], this.B = e.getContext("2d"), this.Ua = e, this.I = []
                            },
                            save: function() {
                                this.T.push(...this.T.slice(this.T.length - 6)), this.G.push(this.G[this.G.length - 1]), this.I.push(this.B.save.bind(this.B))
                            },
                            restore: function() {
                                let e = this.T.length - 6;
                                if (6 > e) throw "restore() called without matching save().";
                                this.T.splice(e), this.G.pop(), this.I.push(this.B.restore.bind(this.B))
                            },
                            transform: function(e, t, n, r, i, a) {
                                let o = this.T,
                                    s = o.length - 6;
                                o.splice(s, 6, o[s] * e + o[s + 2] * t, o[s + 1] * e + o[s + 3] * t, o[s] * n + o[s + 2] * r, o[s + 1] * n + o[s + 3] * r, o[s] * i + o[s + 2] * a + o[s + 4], o[s + 1] * i + o[s + 3] * a + o[s + 5]), this.I.push(this.B.transform.bind(this.B, e, t, n, r, i, a))
                            },
                            rotate: function(e) {
                                let t = Math.sin(e);
                            ...
                            _drawRiveImage: function(e, n, r, i) {
                                ...
                                if (a) {
                                    ...
                                    this.I.push(function() {
                                        o.globalCompositeOperation = s, o.globalAlpha = u, o.drawImage(a, 0, 0), o.globalAlpha = 1
                                    })
                                }
                            },
                            ...
                            _drawImageMesh: function(n, i, a, o, s, u, l, c, h, f, d, p, v, b) {
                                let g, y, w;
                                try {
                                    g = e.HEAPF32.slice(s >> 2, (s >> 2) + u), y = e.HEAPF32.slice(l >> 2, (l >> 2) + c), w = e.HEAPU16.slice(h >> 1, (h >> 1) + f)
                                } catch (e) {
                                    console.error("[Rive] _drawImageMesh: failed to read mesh data from WASM heap. Mesh skipped for this frame.");
                                    return
                                }
                                i = this.B.canvas.width, s = this.B.canvas.height, l = v - d, c = b - p, d = Math.max(d, 0), p = Math.max(p, 0);
                                let _ = (v = Math.min(v, i)) - d,
                                    E = (b = Math.min(b, s)) - p;
                                if (console.assert(_ <= Math.min(l, i)), console.assert(E <= Math.min(c, s)), !(0 >= _ || 0 >= E)) {
                                    v = _ < l || E < c, i = b = 1;
                                    var I = Math.ceil(_ * b),
                                        k = Math.ceil(E * i);
                                    s = m.bc(), I > s && (b *= s / I, I = s), k > s && (i *= s / k, k = s), C || (C = new e.DynamicRectanizer(s)).reset(512, 512), 0 > (s = C.addRect(I, k)) && (r(), A.add(this), console.assert(0 <= (s = C.addRect(I, k))));
                                    var F = 65535 & s,
                                        T = s >> 16;
                                    M.push({
                                    ...
                                    this.I.push(function() {
                                        L.save(), L.resetTransform(), L.globalCompositeOperation = O, L.globalAlpha = x;
                                        let e = m.canvas();
                                        e && L.drawImage(e, F, T, I, k, d, p, _, E), L.restore()
                                    })
                                }
                            },
                            ...
                            clear: function() {
                                A.add(this), this.I.push(this.B.clearRect.bind(this.B, 0, 0, this.Ua.width, this.Ua.height))
                            },
                            flush: function() {},
                            ...
                            return new Proxy(t, {
                                get(e, r) {
                                    ...
                                    if ("function" == typeof n[r]) {
                                        if (-1 < v.indexOf(r)) throw Error("RiveException: Method call to '" + r + "()' is not allowed, as the renderer cannot immediately pass through the return                 values of any canvas 2d context methods.");
                                        return function(...e) {
                        ...
                        e.load = function(t, n, r = !0) {
                            ...
                            return void 0 !== n && i.addLoader(n), r && (n = new e.CDNFileAssetLoader, i.addLoader(n)), new Promise(function(e) {
                                let n = null;
                                k = {
                                    total: 0,
                                    loaded: 0,
                                ...
                                }, n = I(t, i), 0 == k.total && e(n)
                            })
                        };
                        let F = e.RendererWrapper.prototype.align;
                        e.RendererWrapper.prototype.align = function(e, t, n, r, i = 1) {
                            F.call(this, e, t, n, r, i)
                        }, e.requestAnimationFrame = (i = new f).requestAnimationFrame.bind(i), e.cancelAnimationFrame = i.cancelAnimationFrame.bind(i), e.enableFPSCounter = i.Ob.bind(i), e.disableFPSCounter = i.Lb, i.ob = r, e.resolveAnimationFrame = r, e.cleanup = function() {
                            C && C.delete()
                        }
                    };
                    var g, y, w = Object.assign({}, e),
                        _ = "./this.program",
                        A = "";
                    (c || h) && (h ? A = self.location.href : "u" > typeof document && document.currentScript && (A = document.currentScript.src), r && (A = r), A = A.startsWith("blob:") ? "" : A.substr(0, A.replace(/[?#].*/, "").lastIndexOf("/") + 1), h && (y = e => {
                    ...
                    Object.assign(e, w), w = null, e.thisProgram && (_ = e.thisProgram), e.wasmBinary && (P = e.wasmBinary);
                    var P, R, E, I, k, F, T, L, O, x, j = !1;

                    function S() {
                        var t = R.buffer;
                        e.HEAP8 = E = new Int8Array(t), e.HEAP16 = k = new Int16Array(t), e.HEAPU8 = I = new Uint8Array(t), e.HEAPU16 = F = new Uint16Array(t), e.HEAP32 = T = new Int32Array(t), e.HEAPU32 = L = new Uint32Array(t), e.HEAPF32 = O = new Float32Array(t), e.HEAPF64 = x = new Float64Array(t)
                    }
                    var V = [],
                        D = [],
                        B = [],
                    ...
                    function z(t) {
                        throw e.onAbort ? .(t), M(t = "Aborted(" + t + ")"), j = !0, t = new WebAssembly.RuntimeError(t + ". Build with -sASSERTIONS for more info."), u(t), t
                    }
                    var $, H = e => e.startsWith("file://");

                    function Y(e) {
                        if (e == $ && P) return new Uint8Array(P);
                        if (y) return y(e);
                    ...
                    function X(e, t, n) {
                        return (P ? Promise.resolve().then(() => Y(e)) : new Promise((t, n) => {
                            ...
                            M(`failed to asynchronously prepare wasm: ${e}`), z(e)
                        })
                    }
                    var G, q, J = {
                            480578: (e, t, n, r, i) => {
                                ...
                                if (void 0 === window.h) {
                                    window.h = {
                                        za: 0
                                    }, window.h.J = {}, window.h.J.xa = e, window.h.J.capture = t, window.h.J.Ka = n, window.h.ga = {}, window.h.ga.stopped = r, window.h.ga.wb = i;
                                    let a = window.h;
                                    a.D = [], a.sc = function(e) {
                                        ...
                                        for (var t = 0; t < a.D.length; ++t)
                                            if (a.D[t] == e) return a.Ab(t)
                                    }, a.qa = function(e) {
                                        return a.D[e]
                                    }, a.Sa = ["touchend", "click"], a.unlock = function() {
                            ...
                            483335: (e, t, n, r, i, a) => {
                                ...
                                var o = {},
                                    s = {};
                                return e == window.h.J.xa && 0 != n && (s.sampleRate = n), o.L = new(window.AudioContext || window.webkitAudioContext)(s), o.L.suspend(), o.state = window.h.ga.stopped, n = 0, e != window.h.J.xa && (n = t), o.Z = o.L.createScriptProcessor(r, n, t), o.Z.onaudioprocess = function(n) {
                                    if ((null == o.ra || 0 == o.ra.length) && (o.ra = new Float32Array(O.buffer, i, r * t)), e == window.h.J.capture || e == window.h.J.Ka) {
                                        for (var s = 0; s < t; s += 1)
                                            for (var u = n.inputBuffer.getChannelData(s), l = o.ra, c = 0; c < r; c += 1) l[c * t + s] = u[c];
                                        nu(a, r, i)
                                    }
                                    if (e == window.h.J.xa || e == window.h.J.Ka)
                                        for (nl(a, r, i), s = 0; s < n.outputBuffer.numberOfChannels; ++s)
                                            for (u = n.outputBuffer.getChannelData(s), l = o.ra, c = 0; c < r; c += 1) u[c] = l[c * t + s];
                                    else
                                    ...
                                    o.Ca = o.L.createMediaStreamSource(e), o.Ca.connect(o.Z), o.Z.connect(o.L.destination)
                                }).catch(function(e) {
                                    console.log("Failed to get user media: " + e)
                                }), e == window.h.J.xa && o.Z.connect(o.L.destination), o.pb = a, window.h.sc(o)
                            },
                            486212: e => window.h.qa(e).L.sampleRate,
                            486285: e => {
                                void 0 !== (e = window.h.qa(e)).Z && (e.Z.onaudioprocess = function() {}, e.Z.disconnect(), e.Z = void 0), void 0 !== e.Ca && (e.Ca.disconnect(), e.Ca = void 0), e.L.close(), e.L = void 0, e.pb = void 0
                            },
                            486685: e => {
                                window.h.Ab(e)
                            },
                            486735: e => {
                                (e = window.h.qa(e)).L.resume(), e.state = window.h.ga.wb
                            },
                            486874: e => {
                                (e = window.h.qa(e)).L.suspend(), e.state = window.h.ga.stopped
                            }
                        },
                        K = t => {
                    ...
                    var Q = (e, t) => {
                        ...
                        ee = e => {
                            var t = "/" === e.charAt(0),
                                n = "/" === e.substr(-1);
                            return (e = Q(e.split("/").filter(e => !!e), !t).join("/")) || t || (e = "."), e && n && (e += "/"), (t ? "/" : "") + e
                        },
                        et = e => {
                        ...
                        ei = (...e) => {
                            ...
                            return t = Q(t.split("/").filter(e => !!e), !n).join("/"), (n ? "/" : "") + t || "."
                        },
                        ea = "u" > typeof TextDecoder ? new TextDecoder("utf8") : void 0,
                        eo = (e, t, n) => {
                            var r = t + n;
                            for (n = t; e[n] && !(n >= r);) ++n;
                            if (16 < n - t && e.buffer && ea) return ea.decode(e.subarray(t, n));
                            for (r = ""; t < n;) {
                                var i = e[t++];
                                if (128 & i) {
                                    var a = 63 & e[t++];
                    ...
                    function ec(e, t) {
                        var n = Array(eu(e) + 1);
                        return e = el(e, n, 0, n.length), t && (n.length = e), n
                    }
                    var eh = [];
                    ...
                    var ed = {
                        ...
                        read(e, t, n, r) {
                            if (!e.s || !e.s.W.ib) throw new eA(60);
                        ...
                        write(e, t, n, r) {
                            if (!e.s || !e.s.W.Na) throw new eA(60);
                            try {
                                for (var i = 0; i < r; i++) e.s.W.Na(e.s, t[n + i])
                            } catch (e) {
                                throw new eA(29)
                            }
                    ...
                    var ev = {
                            ...
                            createNode(e, t, n, r) {
                                ...
                                }), 16384 == (61440 & (n = eF(e, t, n, r)).mode) ? (n.j = ev.O.dir.node, n.m = ev.O.dir.stream, n.l = {}) : 32768 == (61440 & n.mode) ? (n.j = ev.O.file.node, n.m = ev.O.file.stream, n.v = 0, n.l = null) : 40960 == (61440 & n.mode) ? (n.j = ev.O.link.node, n.m = ev.O.link.stream) : 8192 == (61440 & n.mode) && (n.j = ev.O.ab.node, n.m = ev.O.ab.stream), n.timestamp = Date.now(), e && (e.l[t] = n, e.timestamp = n.timestamp), n
                            },
                            Gc: e => e.l ? e.l.subarray ? e.l.subarray(0, e.v) : new Uint8Array(e.l) : new Uint8Array(0),
                            j: {
                                Y(e) {
                                    var t = {};
                                    return t.Ec = 8192 == (61440 & e.mode) ? e.id : 1, t.Ic = e.id, t.mode = e.mode, t.Lc = 1, t.uid = 0, t.Hc = 0, t.ya = e.ya, 16384 == (61440 & e.mode) ? t.size = 4096 : 32768 == (61440 & e.mode) ? t.size = e.v : 40960 == (61440 & e.mode) ? t.size = e.link.length : t.size = 0, t.wc = new Date(e.timestamp), t.Kc = new Date(e.timestamp), t.Dc = new Date(e.timestamp), t.Hb = 4096, t.xc = Math.ceil(t.size / t.Hb), t
                                },
                                R(e, t) {
                                ...
                                tb(e, t, n) {
                                    if (16384 == (61440 & e.mode)) {
                                        ...
                                        if (r)
                                            for (var i in r.l) throw new eA(55)
                                    }
                                ...
                                Da: (e, t, n) => ((e = ev.createNode(e, t, 41471, 0)).link = n, e),
                                ma(e) {
                            ...
                            m: {
                                ...
                                write(e, t, n, r, i, a) {
                                    if (t.buffer === E.buffer && (a = !1), !r) return 0;
                                    ...
                                    if (ep(e, i + r), e.l.subarray && t.subarray) e.l.set(t.subarray(n, n + r), i);
                                    else
                                        for (a = 0; a < r; a++) e.l[i + a] = t[n + a];
                                    return e.v = Math.max(e.v, i + r), r
                                },
                                ba(e, t, n) {
                                    if (1 === n ? t += e.position : 2 === n && 32768 == (61440 & e.node.mode) && (t += e.node.v), 0 > t) throw new eA(28);
                                    return t
                                },
                                Ya(e, t, n) {
                                    ep(e.node, t + n), e.node.v = Math.max(e.node.v, t + n)
                                },
                                lb(e, t, n, r, i) {
                                    if (32768 != (61440 & e.node.mode)) throw new eA(43);
                                    if (e = e.node.l, 2 & i || e.buffer !== E.buffer) throw (0 < n || n + t < e.length) && (e = e.subarray ? e.subarray(n, n + t) : Array.prototype.slice.call(e, n, n + t)), n = !0, z(), t = void 0, new eA(48);
                        ...
                        eA = class {
                            constructor(e) {
                                this.name = "ErrnoError", this.aa = e
                            }
                        },
                        eC = {},
                        eM = class {
                        ...
                        eP = class {
                            constructor(e, t, n, r) {
                                e || = this, this.parent = e, this.V = e.V, this.va = null, this.id = ey++, this.name = t, this.mode = n, this.j = {}, this.m = {}, this.ya = r
                            }
                            get read() {
                    ...
                    function eR(e, t = {}) {
                        ...
                        if (8 < (t = Object.assign({
                                hb: !0,
                                Pa: 0
                            }, t)).Pa) throw new eA(32);
                        e = e.split("/").filter(e => !!e);
                        for (var n = em, r = "/", i = 0; i < e.length; i++) {
                            var a = i === e.length - 1;
                            if (a && t.parent) break;
                            if (n = ek(n, e[i]), r = ee(r + "/" + e[i]), n.va && (!a || a && t.hb) && (n = n.va.root), !a || t.gb) {
                                for (a = 0; 40960 == (61440 & n.mode);)
                                    if (n = function(e) {
                                            if (!(e = eR(e).node)) throw new eA(44);
                                            if (!e.j.ma) throw new eA(28);
                                            return ei(eE(e.parent), e.j.ma(e))
                                        }(r), n = eR(r = ei(et(r), n), {
                                            Pa: t.Pa + 1
                                        }).node, 40 < a++) throw new eA(32)
                            }
                        }
                        return {
                            path: r,
                    ...
                    function eE(e) {
                        for (var t;;) {
                            if (e === e.parent) return e = e.V.mb, t ? "/" !== e[e.length - 1] ? `${e}/${t}` : e + t : e;
                    ...
                    function eF(e, t, n, r) {
                        return t = eI((e = new eP(e, t, n, r)).parent.id, e.name), e.fc = ew[t], ew[t] = e
                    }
                    ...
                    function ex(e) {
                        if (!(e = eg[e])) throw new eA(8);
                        return e
                    }

                    function ej(e, t = -1) {
                        if (e = Object.assign(new eM, e), -1 == t) e: {
                            for (t = 0; 4096 >= t; t++)
                                if (!eg[t]) break e;
                            throw new eA(33)
                        }
                    ...
                    function eV(e, t) {
                        var n = "/" === t;
                        if (n && em) throw new eA(10);
                        if (!n && t) {
                            var r = eR(t, {
                                hb: !1
                            });
                            if (t = r.path, (r = r.node).va) throw new eA(10);
                        ...
                        t = {
                            ...
                            mb: t,
                            ec: []
                        }, (e = e.V(t)).V = t, t.root = e, n ? em = e : r && (r.va = t, r.V && r.V.ec.push(t))
                    }
                    ...
                    function eD(e, t, n) {
                        ...
                        if (!(e = en(e)) || "." === e || ".." === e) throw new eA(28);
                        var i = eO(r, e);
                        if (i) throw new eA(i);
                        if (!r.j.ua) throw new eA(63);
                    ...
                    function eW(e, t, n) {
                        void 0 === n && (n = t, t = 438), eD(e, 8192 | t, n)
                    }

                    function eU(e, t) {
                        if (!ei(e)) throw new eA(44);
                        var n = eR(t, {
                            parent: !0
                        }).node;
                        ...
                        var r = eO(n, t = en(t));
                        if (r) throw new eA(r);
                        if (!n.j.Da) throw new eA(63);
                        n.j.Da(n, t, e)
                    }

                    function eN(t, n, r) {
                        if ("" === t) throw new eA(44);
                        if ("string" == typeof n) {
                            var i = {
                                r: 0,
                                "r+": 2,
                        ...
                        if (i = !1, 64 & n)
                            if (a) {
                                if (128 & n) throw new eA(20)
                            } else a = eD(t, r, 0), i = !0;
                        if (!a) throw new eA(44);
                        if (8192 == (61440 & a.mode) && (n &= -513), 65536 & n && 16384 != (61440 & a.mode)) throw new eA(54);
                        if (!i && (r = a ? 40960 == (61440 & a.mode) ? 32 : 16384 == (61440 & a.mode) && ("r" !== eT(n) || 512 & n) ? 31 : eL(a, eT(n)) : 44)) throw new eA(r);
                        if (512 & n && !i) {
                            if (!(r = "string" == typeof(r = a) ? eR(r, {
                                    gb: !0
                                }).node : r).j.R) throw new eA(63);
                            if (16384 == (61440 & r.mode)) throw new eA(31);
                            if (32768 != (61440 & r.mode)) throw new eA(28);
                            if (i = eL(r, "w")) throw new eA(i);
                            r.j.R(r, {
                                size: 0,
                                timestamp: Date.now()
                            })
                        }
                        return n &= -131713, (a = ej({
                            node: a,
                            path: eE(a),
                            flags: n,
                            seekable: !0,
                            ...
                            tc: [],
                            error: !1
                        })).m.open && a.m.open(a), !e.logReadFiles || 1 & n || t in (eX || = {}) || (eX[t] = 1), a
                    }

                    function ez(e, t, n) {
                        if (null === e.X) throw new eA(8);
                        if (!e.seekable || !e.m.ba) throw new eA(70);
                        if (0 != n && 1 != n && 2 != n) throw new eA(28);
                        e.position = e.m.ba(e, t, n), e.tc = []
                    }
                    ...
                    var eH, eY, eX, eG, eq, eJ, eK, eZ, eQ = {},
                        e0 = void 0,
                        e1 = (e, t) => Object.defineProperty(t, "name", {
                            value: e
                        }),
                        e2 = [],
                        e4 = [],
                        ...
                        ti = (e, t) => {
                            var n = tn[e];
                            if (void 0 === n) throw e = `${t} has unknown type ${tr(e)}`, new eG(e);
                            return n
                        },
                        ta = () => {},
                        to = !1,
                        ts = (e, t, n) => t === n ? e : void 0 === n.C || null === (e = ts(e, t, n.C)) ? null : n.Mb(e),
                        tu = {},
                        tl = (e, t) => {
                            if (!t.u || !t.o) throw new eZ("makeClassHandle requires ptr and ptrType");
                            if (!!t.K != !!t.F) throw new eZ("Both smartPtrType and smartPtr must be specified");
                            return t.count = {
                                value: 1
                            }, tc(Object.create(e, {
                                g: {
                        ...
                        tc = e => "u" < typeof FinalizationRegistry ? (tc = e => e, e) : (to = new FinalizationRegistry(e => {
                            e = e.g, --e.count.value, 0 === e.count.value && (e.F ? e.K.P(e.F) : e.u.i.P(e.o))
                        }), tc = e => {
                            var t = e.g;
                    ...
                    var tp = {},
                        ...
                        tm = (e, t, n) => {
                            function r(t) {
                                if ((t = n(t)).length !== e.length) throw new eZ("Mismatched type converter count");
                            ...
                            var i = Array(t.length),
                                ...
                                o = 0;
                            t.forEach((e, t) => {
                                tn.hasOwnProperty(e) ? i[t] = tn[e] : (a.push(e), tp.hasOwnProperty(e) || (tp[e] = []), tp[e].push(() => {
                                    i[t] = tn[e], ++o === a.length && r(i)
                                }))
                            }), 0 === a.length && r(i)
                        };
                    ...
                    function tb(e, t, n = {}) {
                        ...
                        return function(e, t, n = {}) {
                            ...
                            tn[e] = t, delete tv[e], tp.hasOwnProperty(e) && (t = tp[e], delete tp[e], t.forEach(e => e()))
                        }(e, t, n)
                    }
                    var tg = e => {
                    ...
                    var tw = (e, t, n) => {
                        ...
                        t_ = (t, n, r) => {
                            if (e.hasOwnProperty(t)) {
                                ...
                                if (tw(e, t, t), e.hasOwnProperty(r)) throw new eG(`Cannot register multiple overloads of a function with the same number of arguments (${r})!`);
                                e[t].A[r] = n
                            } else e[t] = n, void 0 !== r && (e[t].Mc = r)
                        };

                    function tA(e, t, n, r, i, a, o, s) {
                        this.name = e, this.constructor = t, this.N = n, this.P = r, this.C = i, this.Rb = a, this.na = o, this.Mb = s, this.qb = []
                    }
                    var tC = (e, t, n) => {
                        for (; t !== n;) {
                            if (!t.na) throw new eG(`Expected null or instance of ${n.name}, got an instance of ${t.name}`);
                            e = t.na(e), t = t.C
                        }
                        return e
                    };
                    ...
                    function tM(e, t) {
                        if (null === t) {
                            if (this.Ma) throw new eG(`null is not a valid ${this.name}`);
                            return 0
                        }
                        if (!t.g) throw new eG(`Cannot pass "${tN(t)}" as a ${this.name}`);
                    ...
                    function tP(e, t) {
                        if (null === t) {
                            ...
                            if (this.ta) {
                                var n = this.Oa();
                                return null !== e && e.push(this.P, n), n
                            }
                            return 0
                        }
                        if (!t || !t.g) throw new eG(`Cannot pass "${tN(t)}" as a ${this.name}`);
                        if (!t.g.o) throw new eG(`Cannot pass deleted object as a pointer of type ${this.name}`);
                        if (!this.sa && t.g.u.sa) throw new eG(`Cannot convert argument of type ${t.g.K?t.g.K.name:t.g.u.name} to parameter type ${this.name}`);
                        if (n = tC(t.g.o, t.g.u.i, this.i), this.ta) {
                            if (void 0 === t.g.F) throw new eG("Passing raw pointer to smart pointer is illegal");
                            switch (this.nc) {
                                case 0:
                                    if (t.g.K === this) n = t.g.F;
                                    else throw new eG(`Cannot convert argument of type ${t.g.K?t.g.K.name:t.g.u.name} to parameter type ${this.name}`);
                                    break;
                                case 1:
                                    n = t.g.F;
                                    break;
                                case 2:
                                    if (t.g.K === this) n = t.g.F;
                                        ...
                                        var r = t.clone();
                                        n = this.jc(n, e6(() => r.delete())), null !== e && e.push(this.P, n)
                                    }
                                    break;
                                default:
                    ...
                    function tR(e, t) {
                        ...
                        if (!t.g) throw new eG(`Cannot pass "${tN(t)}" as a ${this.name}`);
                        if (!t.g.o) throw new eG(`Cannot pass deleted object as a pointer of type ${this.name}`);
                        if (t.g.u.sa) throw new eG(`Cannot convert argument of type ${t.g.u.name} to parameter type ${this.name}`);
                        return tC(t.g.o, t.g.u.i, this.i)
                    }

                    function tE(e, t, n, r, i, a, o, s, u, l, c) {
                        this.name = e, this.i = t, this.Ma = n, this.sa = r, this.ta = i, this.ic = a, this.nc = o, this.rb = s, this.Oa = u, this.jc = l, this.P = c, i || void 0 !== t.C ? this.toWireType = tP : (this.toWireType = r ? tM : tR, this.M = null)
                    }
                    var tI, tk, tF = (t, n, r) => {
                            if (!e.hasOwnProperty(t)) throw new eZ("Replacing nonexistent public symbol");
                            void 0 !== e[t].A && void 0 !== r ? e[t].A[r] = n : (e[t] = n, e[t].ea = r)
                        },
                        tT = [],
                        tL = e => {
                            var t = tT[e];
                        ...
                        tO = (t, n) => {
                            let r;
                            var i = (t = e8(t)).includes("j") ? (r = t, (...t) => ((t, n, r = []) => t.includes("j") ? (0, e["dynCall_" + (t = t.replace(/p/g, "i"))])(n, ...r) : tL(n)(...r))(r, n, t)) : tL(n);
                            if ("function" != typeof i) throw new eG(`unknown function pointer with signature ${t}: ${n}`);
                            return i
                        },
                        tx = (e, t) => {
                            var n = [],
                            ...
                            throw t.forEach(function e(t) {
                                r[t] || tn[t] || (tv[t] ? tv[t].forEach(e) : (n.push(t), r[t] = !0))
                    ...
                    function tj(e, t, n, r, i) {
                        ...
                        var o = null !== t[1] && null !== n,
                            s = function(e) {
                                for (var t = 1; t < e.length; ++t)
                                    if (null !== e[t] && void 0 === e[t].M) return !0;
                                return !1
                            }(t),
                            u = "void" !== t[0].name,
                            l = a - 2,
                        ...
                        return e1(e, function(...n) {
                            ...
                            if (f.length = 0, h.length = o ? 2 : 1, h[0] = i, o) {
                                var a = t[1].toWireType(f, this);
                                h[1] = a
                            }
                            for (var d = 0; d < l; ++d) c[d] = t[d + 2].toWireType(f, n[d]), h.push(c[d]);
                            if (n = r(...h), s) tf(f);
                            else
                    ...
                    var tS, tV = (e, t) => {
                            for (var n = [], r = 0; r < e; r++) n.push(L[t + 4 * r >> 2]);
                            return n
                        },
                        tD = e => {
                        ...
                        tW = e => {
                            9 < e && 0 == --e4[e + 1] && (e4[e] = void 0, e2.push(e))
                        },
                        tU = {
                            name: "emscripten::val",
                            fromWireType: e => {
                        ...
                        tz = "u" > typeof TextDecoder ? new TextDecoder("utf-16le") : void 0,
                        t$ = (e, t) => {
                            for (var n = e >> 1, r = n + t / 2; !(n >= r) && F[n];) ++n;
                            if (32 < (n <<= 1) - e && tz) return tz.decode(I.subarray(e, n));
                            for (r = 0, n = ""; !(r >= t / 2); ++r) {
                                var i = k[e + 2 * r >> 1];
                                if (0 == i) break;
                        ...
                        tH = (e, t, n) => {
                            ...
                            for (var i = 0; i < n; ++i) k[t >> 1] = e.charCodeAt(i), t += 2;
                            return k[t >> 1] = 0, t - r
                        },
                        tY = e => 2 * e.length,
                        tX = (e, t) => {
                        ...
                        tG = (e, t, n) => {
                            ...
                            for (var i = 0; i < e.length; ++i) {
                                ...
                                if (55296 <= a && 57343 >= a && (a = 65536 + ((1023 & a) << 10) | 1023 & e.charCodeAt(++i)), T[t >> 2] = a, (t += 4) + 4 > n) break
                            }
                            return T[t >> 2] = 0, t - r
                        },
                        tq = e => {
                        ...
                        tJ = (e, t, n) => {
                            var r = [];
                            return e = e.toWireType(r, n), r.length && (L[t >> 2] = e6(r)), e
                        },
                        tK = [],
                        tZ = {},
                        tQ = e => {
                        ...
                        t1 = e => 0 == e % 4 && (0 != e % 100 || 0 == e % 400),
                        t2 = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335],
                        t4 = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334],
                        t3 = [],
                        t6 = {},
                        t5 = () => {
                            if (!tS) {
                                ...
                                for (e in t6) void 0 === t6[e] ? delete t[e] : t[e] = t6[e];
                                var n = [];
                        ...
                        t8 = [31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31],
                        t7 = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31],
                        t9 = (e, t, n, r) => {
                            function i(e, t, n) {
                            ...
                            for (c in l = {
                                    ...
                                    "%G": u,
                                    "%H": e => a(e.Ea, 2),
                                    "%I": e => (0 == (e = e.Ea) ? e = 12 : 12 < e && (e -= 12), a(e, 2)),
                                    "%j": e => {
                                    ...
                                    "%V": e => {
                                        ...
                                        if (2 >= (e.S + 371 - e.ca - 2) % 7 && t++, t) 53 == t && (4 == (n = (e.S + 371 - e.ca) % 7) || 3 == n && t1(e.da) || (t = 1));
                                        else {
                                            t = 52;
                            ...
                            return (c = ec(n = n.replace(/\0\0/g, "%"), !1)).length > t ? 0 : (E.set(c, e), c.length - 1)
                        };
                    [44].forEach(e => {
                        eC[e] = new eA(e), eC[e].stack = "<generic error, no stack>"
                    }), ew = Array(4096), eV(ev, "/"), eB("/tmp"), eB("/home"), eB("/home/web_user"), eB("/dev"), eb[259] = {
                        m: {
                            read: () => 0,
                            write: (e, t, n, r) => r
                        }
                    }, eW("/dev/null", 259), ef(1280, {
                        ib() {
                            e: {
                                if (!es.length) {
                                    var e = null;
                        ...
                        Na(e, t) {
                            null === t || 10 === t ? (C(eo(e.H, 0)), e.H = []) : 0 != t && e.H.push(t)
                        },
                        pa(e) {
                            e.H && 0 < e.H.length && (C(eo(e.H, 0)), e.H = [])
                        },
                        Yb: () => ({
                            Ac: 25856,
                            Cc: 5,
                        ...
                        Na(e, t) {
                            null === t || 10 === t ? (M(eo(e.H, 0)), e.H = []) : 0 != t && e.H.push(t)
                        },
                        pa(e) {
                            e.H && 0 < e.H.length && (M(eo(e.H, 0)), e.H = [])
                        }
                    }), eW("/dev/tty", 1280), eW("/dev/tty1", 1536), t = new Uint8Array(1024), n = 0, e$("random", i = () => (0 === n && (n = er(t).byteLength), t[--n])), e$("urandom", i), eB("/dev/shm"), eB("/dev/shm/tmp"), eB("/proc"), a = eB("/proc/self"), eB("/proc/self/fd"), eV({
                        V() {
                    ...
                    }, e4.push(0, 1, void 0, 1, null, 1, !0, 1, !1, 1), e.count_emval_handles = () => e4.length / 2 - 5 - e2.length, eq = e.PureVirtualError = e5("PureVirtualError");
                    for (var ne = Array(256), nt = 0; 256 > nt; ++nt) ne[nt] = String.fromCharCode(nt);
                    eJ = ne, e.getInheritedInstanceCount = () => Object.keys(te).length, e.getLiveInheritedInstances = () => {
                        var e, t = [];
                        for (e in te) te.hasOwnProperty(e) && t.push(te[e]);
                        return t
                    }, e.flushPendingDeletes = e9, e.setDelayFunction = e => {
                        eK = e, e7.length && eK && eK(e9)
                        ...
                        isAliasOf: function(e) {
                            if (!(this instanceof ty && e instanceof ty)) return !1;
                            var t = this.g.u.i,
                                n = this.g.o;
                            e.g = e.g;
                            var r = e.g.u.i;
                            for (e = e.g.o; t.C;) n = t.na(n), t = t.C;
                            for (; r.C;) e = r.na(e), r = r.C;
                            return t === r && n === e
                        },
                        clone: function() {
                            if (this.g.o || tg(this), this.g.ia) return this.g.count.value += 1, this;
                            var e = tc,
                                t = Object,
                                n = t.create,
                        ...
                        delete() {
                            if (this.g.o || tg(this), this.g.fa && !this.g.ia) throw new eG("Object already scheduled for deletion");
                            ta(this);
                            var e = this.g;
                            --e.count.value, 0 === e.count.value && (e.F ? e.K.P(e.F) : e.u.i.P(e.o)), this.g.ia || (this.g.F = void 0, this.g.o = void 0)
                        },
                        isDeleted: function() {
                            return !this.g.o
                        },
                        deleteLater: function() {
                            if (this.g.o || tg(this), this.g.fa && !this.g.ia) throw new eG("Object already scheduled for deletion");
                            return e7.push(this), 1 === e7.length && eK && eK(e9), this.g.fa = !0, this
                        }
                        ...
                        fromWireType: function(e) {
                            ...
                            if (!(r = tu[r = this.i.Rb(n)])) return t.call(this);
                    ...
                    var nn = {
                                ...
                                try {
                                    ...
                                    switch (t) {
                                        ...
                                        case 3:
                                            return r.flags;
                                        case 4:
                                            return i = Z(), r.flags |= i, 0;
                                        case 12:
                                            return k[(i = Z()) + 0 >> 1] = 2, 0
                                    }
                                    return -28
                                } catch (e) {
                                    ...
                                    switch (t) {
                                        ...
                                        case 21505:
                                            ...
                                            if (r.s.W.Yb) {
                                                ...
                                                var i = Z();
                                                T[i >> 2] = 25856, T[i + 4 >> 2] = 5, T[i + 8 >> 2] = 191, T[i + 12 >> 2] = 35387;
                                                for (var a = 0; 32 > a; a++) E[i + a + 17] = e[a] || 0
                                            }
                                            return 0;
                                        case 21506:
                                        case 21507:
                                        case 21508:
                                            if (!r.s) return -59;
                                            if (r.s.W.Zb)
                                                for (i = Z(), e = [], a = 0; 32 > a; a++) e.push(E[i + a + 17]);
                                            return 0;
                                        case 21519:
                                            if (!r.s) return -59;
                                            return T[(i = Z()) >> 2] = 0;
                                        case 21520:
                                            return r.s ? -28 : -59;
                                        case 21531:
                                            if (i = Z(), !r.m.Xb) throw new eA(59);
                                            return r.m.Xb(r, t, i);
                                        case 21523:
                                            if (!r.s) return -59;
                                            return r.s.W.$b && (a = [24, 80], k[(i = Z()) >> 1] = a[0], k[i + 2 >> 1] = a[1]), 0;
                                        default:
                                            return -28
                                    }
                                } catch (e) {
                            ...
                            _embind_create_inheriting_constructor: (e, t, n) => {
                                ...
                                return e = e1(e, function(...e) {
                                    r.C.qb.forEach((function(e) {
                                        if (this[e] === a[e]) throw new eq(`Pure virtual function ${e} must be implemented in JavaScript`)
                                    ...
                                    var t = e.g;
                                    if (e.notifyOnDestruction(), t.ia = !0, Object.defineProperties(this, {
                                            g: {
                                                value: t
                                            }
                                        }), tc(this), e = tt(r, e = t.o), te.hasOwnProperty(e)) throw new eG(`Tried to register registered instance: ${e}`);
                                    te[e] = this
                                ...
                                }, e.prototype = Object.create(i), Object.assign(e.prototype, n), e6(e)
                            },
                            ...
                            _embind_register_class: (e, t, n, r, i, a, o, s, u, l, c, h, f) => {
                                c = e8(c), a = tO(i, a), s && = tO(o, s), l && = tO(u, l), f = tO(h, f);
                                var d = (e => {
                                ...
                                t_(d, function() {
                                    ...
                                    var u = Object.create(o, {
                                        constructor: {
                                            value: t = e1(c, function(...e) {
                                                ...
                                                if (void 0 === h.$) throw new eG(c + " has no accessible constructor");
                                                var t = h.$[e.length];
                                                if (void 0 === t) throw new eG(`Tried to invoke ctor of ${c} with invalid number of parameters (${e.length}) - expected (${Object.keys(h.$).toString()}) parameters instead!`);
                                    ...
                                    return h.C && ((n = h.C).oa ? ? (n.oa = []), h.C.oa.push(h)), i = new tE(c, h, !0, !1, !1), n = new tE(c + "*", h, !1, !1, !1), o = new tE(c + " const*", h, !1, !0, !1), tu[e] = {
                                        pointerType: n,
                                        Ib: o
                                    }, tF(d, t), [i, n, o]
                                })
                            ...
                            _embind_register_class_class_function: (e, t, n, r, i, a, o) => {
                                ...
                                t = tD(t = e8(t)), a = tO(i, a), tm([], [e], e => {
                                    ...
                                    return void 0 === u[t] ? (r.ea = n - 1, u[t] = r) : (tw(u, t, i), u[t].A[n - 1] = r), tm([], s, r => {
                                        if (r = tj(i, [r[0], null].concat(r.slice(1)), null, a, o), void 0 === u[t].A ? (r.ea = n - 1, u[t] = r) : u[t].A[n - 1] = r, e.i.oa)
                            ...
                            _embind_register_class_class_property: (e, t, n, r, i, a, o, s) => {
                                t = e8(t), a = tO(i, a), tm([], [e], e => {
                                    ...
                                    }, Object.defineProperty(e.i.constructor, t, u), tm([], [n], n => {
                                        n = n[0];
                                        var i = {
                                            get: () => n.fromWireType(a(r)),
                                            enumerable: !0
                                        };
                                        return s && (s = tO(o, s), i.set = e => {
                                            var t = [];
                                            s(r, n.toWireType(t, e)), tf(t)
                            ...
                            _embind_register_class_constructor: (e, t, n, r, i, a) => {
                                ...
                                i = tO(r, i), tm([], [e], e => {
                                    ...
                                    if (void 0 === e.i.$ && (e.i.$ = []), void 0 !== e.i.$[t - 1]) throw new eG(`Cannot register multiple constructors with identical number of parameters (${t-1}) for class '${e.name}'! Overload resolution is currently only performed using the parameter count, not actual type info!`);
                                    return e.i.$[t - 1] = () => {
                                        tx(`Cannot construct ${e.name} due to unbound types`, o)
                                    }, tm([], o, r => (r.splice(1, 0, null), e.i.$[t - 1] = tj(n, r, null, i, a), [])), []
                                })
                            },
                            _embind_register_class_function: (e, t, n, r, i, a, o, s) => {
                                ...
                                t = tD(t = e8(t)), a = tO(i, a), tm([], [e], e => {
                                    ...
                                    var l = e.i.N,
                                        c = l[t];
                                    return void 0 === c || void 0 === c.A && c.className !== e.name && c.ea === n - 2 ? (r.ea = n - 2, r.className = e.name, l[t] = r) : (tw(l, t, i), l[t].A[n - 2] = r), tm([], u, r => (r = tj(i, r, e, a, o), void 0 === l[t].A ? (r.ea = n - 2, l[t] = r) : l[t].A[n - 2] = r, [])), []
                                })
                            },
                            _embind_register_class_property: (e, t, n, r, i, a, o, s, u, l) => {
                                t = e8(t), i = tO(r, i), tm([], [e], e => {
                                    e = e[0];
                                    var r = `${e.name}.${t}`,
                                        c = {
                                            get() {
                                    ...
                                    }, Object.defineProperty(e.i.N, t, c), tm([], u ? [n, o] : [n], n => {
                                        var o = n[0],
                                            c = {
                                                get() {
                            ...
                            _embind_register_enum_value: (e, t, n) => {
                                var r = ti(e, "enum");
                                t = e8(t), e = r.constructor, r = Object.create(r.constructor.prototype, {
                                    value: {
                                        value: n
                                    },
                                    constructor: {
                            ...
                            _embind_register_function: (e, t, n, r, i, a) => {
                                var o = tV(t, n);
                                e = tD(e = e8(e)), i = tO(r, i), t_(e, function() {
                                    tx(`Cannot call ${e} due to unbound types`, o)
                                }, t - 1), tm([], o, n => (tF(e, tj(e, [n[0], null].concat(n.slice(1)), null, i, a), t - 1), []))
                            },
                            _embind_register_integer: (e, t, n, r, i) => {
                                if (t = e8(t), -1 === i && (i = 0xffffffff), i = e => e, 0 === r) {
                                    var a = 32 - 8 * n;
                                    i = e => e << a >>> a
                                }
                                ...
                                tb(e, {
                                    ...
                                    fromWireType: function(e) {
                                        ...
                                        if (n)
                                            for (var i = r, a = 0; a <= t; ++a) {
                                                var o = r + a;
                                                if (a == t || 0 == I[o]) {
                                                    if (i = i ? eo(I, i, o - i) : "", void 0 === s) var s = i;
                                                    else s += "\0", s += i;
                                                    i = o + 1
                                                }
                                            } else {
                                                for (a = 0, s = Array(t); a < t; ++a) s[a] = String.fromCharCode(I[r + a]);
                                                s = s.join("")
                                            }
                                        return ni(e), s
                                    },
                                    toWireType: function(e, t) {
                                        ...
                                        var i = n && r ? eu(t) : t.length,
                                            a = na(4 + i + 1),
                                            o = a + 4;
                                        if (L[a >> 2] = i, n && r) el(t, I, o, i + 1);
                                        else if (r)
                                            for (r = 0; r < i; ++r) {
                                                var s = t.charCodeAt(r);
                                                if (255 < s) throw ni(o), new eG("String has UTF-16 code units that do not fit in 8 bits");
                                                I[o + r] = s
                                            } else
                                                for (r = 0; r < i; ++r) I[o + r] = t[r];
                            ...
                            _embind_register_std_wstring: (e, t, n) => {
                                if (n = e8(n), 2 === t) var r = t$,
                                    i = tH,
                                    a = tY,
                                    o = e => F[e >> 1];
                                else 4 === t && (r = tX, i = tG, a = tq, o = e => L[e >> 2]);
                                tb(e, {
                                    name: n,
                                    fromWireType: e => {
                                        for (var n, i = L[e >> 2], a = e + 4, s = 0; s <= i; ++s) {
                                            var u = e + 4 + s * t;
                                            (s == i || 0 == o(u)) && (a = r(a, u - a), void 0 === n ? n = a : (n += "\0", n += a), a = u + t)
                                        }
                                        return ni(e), n
                                    },
                                    toWireType: (e, r) => {
                                        ...
                                        var o = a(r),
                                            s = na(4 + o + t);
                                        return L[s >> 2] = o / t, i(r, s + 4, o + t), null !== e && e.push(ni, s), s
                                    },
                                    argPackAdvance: 8,
                                    readValueFromPointer: td,
                                    M(e) {
                            ...
                            _emval_as: (e, t, n) => (e = e3(e), tJ(t = ti(t, "emval::as"), n, e)),
                            ...
                            _emval_get_method_caller: (e, t, n) => {
                                var r, i, a = ((e, t) => {
                                        for (var n = Array(e), r = 0; r < e; ++r) n[r] = ti(L[t + 4 * r >> 2], "parameter " + r);
                                        return n
                                    })(e, t),
                                    o = a.shift(),
                                    s = Array(--e);
                                return r = e1(t = `methodCaller<(${a.map(e=>e.name).join(", ")}) => ${o.name}>`, (t, r, i, u) => {
                                    for (var l = 0, c = 0; c < e; ++c) s[c] = a[c].readValueFromPointer(u + l), l += a[c].argPackAdvance;
                                    return tJ(o, i, t = 1 === n ? t0(r, s) : r.apply(t, s))
                                }), i = tK.length, tK.push(r), i
                            },
                            ...
                            _emval_set_property: (e, t, n) => {
                                e = e3(e), t = e3(t), n = e3(n), e[t] = n
                            },
                            _emval_take_value: (e, t) => e6(e = (e = ti(e, "_emval_take_value")).readValueFromPointer(t)),
                            _gmtime_js: function(e, t, n) {
                                e = new Date(1e3 * (t + 2097152 >>> 0 < 4194305 - !!e ? (e >>> 0) + 0x100000000 * t : NaN)), T[n >> 2] = e.getUTCSeconds(), T[n + 4 >> 2] = e.getUTCMinutes(), T[n + 8 >> 2] = e.getUTCHours(), T[n + 12 >> 2] = e.getUTCDate(), T[n + 16 >> 2] = e.getUTCMonth(), T[n + 20 >> 2] = e.getUTCFullYear() - 1900, T[n + 24 >> 2] = e.getUTCDay(), T[n + 28 >> 2] = (e.getTime() - Date.UTC(e.getUTCFullYear(), 0, 1, 0, 0, 0, 0)) / 864e5 | 0
                            },
                            _localtime_js: function(e, t, n) {
                                e = new Date(1e3 * (t + 2097152 >>> 0 < 4194305 - !!e ? (e >>> 0) + 0x100000000 * t : NaN)), T[n >> 2] = e.getSeconds(), T[n + 4 >> 2] = e.getMinutes(), T[n + 8 >> 2] = e.getHours(), T[n + 12 >> 2] = e.getDate(), T[n + 16 >> 2] = e.getMonth(), T[n + 20 >> 2] = e.getFullYear() - 1900, T[n + 24 >> 2] = e.getDay(), T[n + 28 >> 2] = (t1(e.getFullYear()) ? t2 : t4)[e.getMonth()] + e.getDate() - 1 | 0, T[n + 36 >> 2] = -(60 * e.getTimezoneOffset()), t = new Date(e.getFullYear(), 6, 1).getTimezoneOffset();
                            ...
                            _tzset_js: (e, t, n, r) => {
                                ...
                                L[e >> 2] = 60 * Math.max(i, s), T[t >> 2] = Number(i != s), a = (e = e => e.toLocaleTimeString(void 0, {
                                    hour12: !1,
                                    timeZoneName: "short"
                                }).split(" ")[1])(a), o = e(o), s < i ? (el(a, I, n, 17), el(o, I, r, 17)) : (el(a, I, r, 17), el(o, I, n, 17))
                            },
                            emscripten_asm_const_int: (e, t, n) => {
                                t3.length = 0;
                                for (var r; r = I[t++];) {
                                    var i = 105 != r;
                                    i &= 112 != r, n += i && n % 8 ? 4 : 0, t3.push(112 == r ? L[n >> 2] : 105 == r ? T[n >> 2] : x[n >> 3]), n += i ? 8 : 4
                                }
                                return J[e](...t3)
                            },
                            ...
                            environ_get: (e, t) => {
                                ...
                                return t5().forEach((r, i) => {
                                    var a = t + n;
                                    for (i = L[e + 4 * i >> 2] = a, a = 0; a < r.length; ++a) E[i++] = r.charCodeAt(a);
                                    E[i] = 0, n += r.length + 1
                                }), 0
                            },
                            environ_sizes_get: (e, t) => {
                                ...
                                L[e >> 2] = n.length;
                                var r = 0;
                                return n.forEach(e => r += e.length + 1), L[t >> 2] = r, 0
                            },
                            fd_close: function(e) {
                                try {
                                    var t = ex(e);
                                    if (null === t.X) throw new eA(8);
                                    t.La && (t.La = null);
                                    try {
                                ...
                                try {
                                    e: {
                                        ...
                                        for (var a, o = t = 0; o < n; o++) {
                                            ...
                                            var l = a,
                                                c = E;
                                            if (0 > u || 0 > l) throw new eA(28);
                                            if (null === i.X || 1 == (2097155 & i.flags)) throw new eA(8);
                                            if (16384 == (61440 & i.node.mode)) throw new eA(31);
                                            if (!i.m.read) throw new eA(28);
                                            var h = void 0 !== l;
                                            if (h) {
                                                if (!i.seekable) throw new eA(70)
                                            } else l = i.position;
                            ...
                            fd_seek: function(e, t, n, r, i) {
                                ...
                                try {
                                    ...
                                    var a = ex(e);
                                    return ez(a, t, r), q = [a.position >>> 0, (G = a.position, 1 <= +Math.abs(G) ? 0 < G ? Math.floor(G / 0x100000000) >>> 0 : ~~Math.ceil((G - (~~G >>> 0)) / 0x100000000) >>> 0 : 0)], T[i >> 2] = q[0], T[i + 4 >> 2] = q[1], a.La && 0 === t && 0 === r && (a.La = null), 0
                                } catch (e) {
                                    if (void 0 === eQ || "ErrnoError" !== e.name) throw e;
                                    return e.aa
                                }
                                    ...
                                    e: {
                                        ...
                                        for (var a, o = t = 0; o < n; o++) {
                                            ...
                                            var l = a,
                                                c = E;
                                            if (0 > u || 0 > l) throw new eA(28);
                                            if (null === i.X || 0 == (2097155 & i.flags)) throw new eA(8);
                                            if (16384 == (61440 & i.node.mode)) throw new eA(31);
                                            if (!i.m.write) throw new eA(28);
                        ...
                        nr = function() {
                            function t(t) {
                                return R = (nr = t.exports).memory, S(), tI = nr.__indirect_function_table, D.unshift(nr.__wasm_call_ctors), W--, e.monitorRunDependencies ? .(W), 0 == W && (null !== U && (clearInterval(U), U = null), N && (t = N, N = null, t())), nr
                            }
                            var n, r, i = {
                                env: nn,
                                wasi_snapshot_preview1: nn
                            };
                            if (W++, e.monitorRunDependencies ? .(W), e.instantiateWasm) try {
                                return e.instantiateWasm(i, t)
                            } catch (e) {
                                M(`Module.instantiateWasm callback failed with error: ${e}`), u(e)
                            }
                            return $ || = "canvas_advanced.wasm".startsWith("data:application/octet-stream;base64,") ? "canvas_advanced.wasm" : e.locateFile ? e.locateFile("canvas_advanced.wasm", A) : A + "canvas_advanced.wasm", (n = i, r = function(e) {
                                t(e.instance)
                                ...
                                return M(`wasm streaming compile failed: ${e}`), M("falling back to ArrayBuffer instantiation"), X($, n, r)
                            }))).catch(u), {}
                        }(),
                        ni = e => (ni = nr.free)(e),
                        na = e => (na = nr.malloc)(e),
                    ...
                    e._ma_malloc_emscripten = (t, n) => (e._ma_malloc_emscripten = nr.ma_malloc_emscripten)(t, n), e._ma_free_emscripten = (t, n) => (e._ma_free_emscripten = nr.ma_free_emscripten)(t, n);
                    ...
                    function nd() {
                        function t() {
                            if (!o && (o = !0, e.calledRun = !0, !j)) {
                                if (e.noFSInit || eH || (eH = !0, e.stdin = e.stdin, e.stdout = e.stdout, e.stderr = e.stderr, e.stdin ? e$("stdin", e.stdin) : eU("/dev/tty", "/dev/stdin"), e.stdout ? e$("stdout", null, e.stdout) : eU("/dev/tty", "/dev/stdout"), e.stderr ? e$("stderr", null, e.stderr) : eU("/dev/tty1", "/dev/stderr"), eN("/dev/stdin", 0), eN("/dev/stdout", 1), eN("/dev/stderr", 1)), e_ = !1, K(D), s(e), e.onRuntimeInitialized && e.onRuntimeInitialized(), e.postRun)
                        ...
                        if (!(0 < W)) {
                            ...
                            K(V), 0 < W || (e.setStatus ? (e.setStatus("Running..."), setTimeout(function() {
                                setTimeout(function() {
                                    e.setStatus("")
                                }, 1), t()
                            }, 1)) : t())
                ...
                var r = void 0,
                    ...
                    a = function(e, t, n, r) {
                        var a;
                        return (null == (a = e.changedTouches) ? void 0 : a.length) ? (!t && ["touchstart", "touchmove"].includes(e.type) && e.preventDefault(), i(e.changedTouches, n, r)) : [{
                            clientX: e.clientX,
                            clientY: e.clientY,
                            identifier: 0
                        }]
                    ...
                    o = function(e) {
                        var t = e.canvas,
                            ...
                            g = void 0 === b ? 1 : b;
                        if (!t || !o.length || !s || !u || !n || "u" < typeof window) return null;
                        var y = null,
                            w = !1,
                            _ = null,
                            A = function() {
                            ...
                            C = (function(e) {
                                ...
                                w = f && "touchend" === e.type && "touchstart" === y, y = e.type;
                                ...
                                var s = a(e, f, m, m ? null : _),
                                    ...
                                    d = new u.Mat2D;
                                switch (h.invert(d), s.forEach(function(e) {
                                    var t = e.clientX,
                                        n = e.clientY;
                                    if (t || n) {
                                        var i = t - r.left,
                                            ...
                                            l = s.x(),
                                            c = s.y();
                                        e.transformedX = l, e.transformedY = c, s.delete(), o.delete()
                                    }
                                }), d.delete(), h.delete(), e.type) {
                                    case "mouseout":
                        ...
                        return t.addEventListener("mouseover", C), t.addEventListener("mouseout", C), t.addEventListener("mousemove", C), t.addEventListener("mousedown", C), t.addEventListener("mouseup", C), t.addEventListener("touchmove", C, {
                                passive: f
                            }), t.addEventListener("touchstart", C, {
                                passive: f
                            }), t.addEventListener("touchend", C), t.addEventListener("touchcancel", A),
                            function() {
                                t.removeEventListener("mouseover", C), t.removeEventListener("mouseout", C), t.removeEventListener("mousemove", C), t.removeEventListener("mousedown", C), t.removeEventListener("mouseup", C), t.removeEventListener("touchmove", C), t.removeEventListener("touchstart", C), t.removeEventListener("touchend", C), t.removeEventListener("touchcancel", A)
                            }
                    }
            }, (e, t, n) => {
                n.r(t), n.d(t, {
                ...
                var r, i = (r = function(e, t) {
                    ...
                    h = function() {
                        ...
                        return e.prototype.loadContents = function(e, t) {
                            var n;
                            return e.isImage ? n = new d(e) : e.isAudio ? n = new p(e) : e.isFont && (n = new v(e)), this._assetLoaderCallback(n, t)
                        }, e
                    }(),
                    f = function() {
                        function e(e) {
                ...
                var r = n(3),
                    i = function() {
                        ...
                        return e.setFallbackFontCallback = function(t) {
                            ...
                            if (null == e) return null;
                            var t, n = e.nativeFont,
                                r = null == (t = null == n ? void 0 : n.ptr) ? void 0 : t.call(n);
                        ...
                        }, e._fallbackFontCallback = null, e
                    }()
            }],
            eh = {};
        ...
        function ef(e) {
            ...
            return ec[e](n, n.exports, ef), n.exports
        }
        ef.d = (e, t) => {
            for (var n in t) ef.o(t, n) && !ef.o(e, n) && Object.defineProperty(e, n, {
                enumerable: !0,
                get: t[n]
            })
        }, ef.o = (e, t) => Object.prototype.hasOwnProperty.call(e, t), ef.r = e => {
        ...
        return ef.r(ed), ef.d(ed, {
            ...
            decodeFont: () => el,
            decodeImage: () => eu
        }), c = ef(1), h = ef(3), f = ef(6), d = function(e, t) {
        ...
        }(), (R = i || (i = {}))[R.General = 128] = "General", R[R.OpenUrl = 131] = "OpenUrl", I = function(e) {
            function t(t, n) {
        ...
        }(), (L = a || (a = {})).Load = "load", L.LoadError = "loaderror", L.Play = "play", L.Pause = "pause", L.Stop = "stop", L.Loop = "loop", L.Draw = "draw", L.Advance = "advance", L.StateChange = "statechange", L.RiveEvent = "riveevent", L.AudioStatusChange = "audiostatuschange", (O = o || (o = {})).OneShot = "oneshot", O.Loop = "loop", O.PingPong = "pingpong", x = function() {
            function e(e) {
        ...
        }(), (S = s || (s = {}))[S.AVAILABLE = 0] = "AVAILABLE", S[S.UNAVAILABLE = 1] = "UNAVAILABLE", V = new(function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
        ...
        }(), B = globalThis.ResizeObserver || D, W = new(function() {
            function e() {
                var e = this;
            ...
            function e(e) {
                this.enableRiveAssetCDN = !0, this.enablePerfMarks = !1, this.referenceCount = 0, this.destroyed = !1, this.selfUnref = !1, this.bindableArtboards = [], this.src = e.src, this.buffer = e.buffer, e.assetLoader && (this.assetLoader = e.assetLoader), this.enableRiveAssetCDN = "boolean" != typeof e.enableRiveAssetCDN || e.enableRiveAssetCDN, this.enablePerfMarks = !!e.enablePerfMarks, this.enablePerfMarks && (h.RuntimeLoader.enablePerfMarks = !0), this.eventManager = new x, e.onLoad && this.on(a.Load, e.onLoad), e.onLoadError && this.on(a.LoadError, e.onLoadError)
            }
            return e.prototype.releaseFile = function() {
                ...
                return m(this, void 0, void 0, function() {
                    ...
                    return b(this, function(o) {
                        switch (o.label) {
                            case 0:
                                if (!(this.src && !this.buffer)) return [3, 2];
                                return t = this, [4, ei(this.src)];
                            case 1:
                                t.buffer = o.sent(), o.label = 2;
                            case 2:
                                if (this.destroyed) return [2];
                                return this.assetLoader && (n = new f.CustomFileAssetLoaderWrapper(this.runtime, this.assetLoader).assetLoader), this.enablePerfMarks && performance.mark("rive:file-load:start"), r = this, [4, this.runtime.load(new Uint8Array(this.buffer), n, this.enableRiveAssetCDN)];
                            case 3:
                                if (r.file = o.sent(), this.enablePerfMarks && (performance.mark("rive:file-load:end"), performance.measure("rive:file-load", "rive:file-load:start", "rive:file-load:end")), i = new f.FileFinalizer(this.file), f.finalizationRegistry.register(this, i), this.destroyed) return this.releaseFile(), [2];
                ...
                return m(this, void 0, void 0, function() {
                    var e;
                    return b(this, function(t) {
                        return this.enablePerfMarks && performance.mark("rive:fetch-riv:start"), e = this.src ? ei(this.src) : Promise.resolve(this.buffer), this.enablePerfMarks && this.src && e.then(function() {
                            performance.mark("rive:fetch-riv:end"), performance.measure("rive:fetch-riv", "rive:fetch-riv:start", "rive:fetch-riv:end")
                        }), [2, e]
                    })
                })
                ...
                return m(this, void 0, void 0, function() {
                    var e;
                    return b(this, function(t) {
                        return this.enablePerfMarks && performance.mark("rive:await-wasm:start"), e = h.RuntimeLoader.awaitInstance(), this.enablePerfMarks && e.then(function() {
                            performance.mark("rive:await-wasm:end"), performance.measure("rive:await-wasm", "rive:await-wasm:start", "rive:await-wasm:end")
                        }), [2, e]
                    })
                })
                    ...
                    return b(this, function(a) {
                        switch (a.label) {
                            case 0:
                                ...
                                a.label = 1;
                            case 1:
                                return a.trys.push([1, 4, , 5]), [4, Promise.all([this.loadRiveFileBytes(), this.loadRuntime()])];
                            case 2:
                                if (n = (t = a.sent())[0], r = t[1], this.destroyed) return [2];
                                return this.buffer = n, this.runtime = r, this.enablePerfMarks && performance.mark("rive:init-data:start"), [4, this.initData()];
                            case 3:
                                return a.sent(), this.enablePerfMarks && (performance.mark("rive:init-data:end"), performance.measure("rive:init-data", "rive:init-data:start", "rive:init-data:end")), [3, 5];
                            case 4:
                                return i = a.sent(), this.fireLoadError(i instanceof Error ? i.message : e.fileLoadErrorMessage), [3, 5];
                            case 5:
                                return [2]
                        }
                    })
            ...
            return Object.defineProperty(t.prototype, "viewModelCount", {
                ...
                if (!this.destroyed) {
                    ...
                    var m = ea(o),
                        b = ea(s);
                    this.loaded = !1, this.readyForPlaying = !1, h.RuntimeLoader.awaitInstance().then(function(e) {
                        n.destroyed || (n.runtime = e, n.removeRiveListeners(), n.deleteRiveRenderer(), n.enablePerfMarks && performance.mark("rive:make-renderer:start"), n.renderer = n.runtime.makeRenderer(n.canvas, d), n.enablePerfMarks && (performance.mark("rive:make-renderer:end"), performance.measure("rive:make-renderer", "rive:make-renderer:start", "rive:make-renderer:end")), n.canvas.width || n.canvas.height || n.resizeDrawingSurfaceToCanvas(), n.initData(u, m, b, c, v).then(function(e) {
                ...
                }, V.add(this._audioEventListener), V.establishAudio())
                ...
                if (this.file) {
                    ...
                    if (this.artboard = s, s.volume = this._volume * V.systemVolume, this.animator = new T(this.runtime, this.artboard, this.eventManager), t.length > 0 || n.length > 0 ? (o = t.concat(n), this.animator.initLinearAnimations(t, r), this.animator.initStateMachines(n, r)) : o = [this.animator.atLeastOne(r, !1)], this.taskQueue.add({
                            event: {
                        ...
                        if (null !== l) {
                            ...
                            if (null !== c) {
                                var h = new X(c, null);
                                (0, f.createFinalization)(h, h.runtimeInstance), this.bindViewModelInstance(h)
                            }
                        }
                    }
                }
                ...
                var e, t;
                (null == (e = null == document ? void 0 : document.timeline) ? void 0 : e.currentTime) ? this.loaded && this.artboard && !this.frameRequestId && (this._boundDraw(document.timeline.currentTime), null == (t = this.runtime) || t.resolveAnimationFrame()): this.scheduleRendering()
                ...
                for (var h = this.animator.stateMachines.filter(function(e) {
                                ...
                                if (g.type === i.OpenUrl) {
                                    if (this.eventManager.fire({
                                        ...
                                        var y = document.createElement("a"),
                                            ...
                                            _ = g.target,
                                            A = (0, f.sanitizeUrl)(w);
                                        w && y.setAttribute("href", A), _ && y.setAttribute("target", _), A && A !== f.BLANK_URL && y.click()
                                    }
                    ...
                    d >= 0 && performance.mark("rive:sm-advance:start:f".concat(d)), v.advanceAndApply(s), d >= 0 && (performance.mark("rive:sm-advance:end:f".concat(d)), performance.measure("rive:sm-advance:f".concat(d), "rive:sm-advance:start:f".concat(d), "rive:sm-advance:end:f".concat(d)))
                }
                0 == this.animator.stateMachines.length && this.artboard.advance(s);
                var C = this.renderer;
                !this._hasZeroSize && (this.drawOptimization == n.AlwaysDraw || this.artboard.didChange() || this._needsRedraw || this._canvasSizeChanged()) && (C.clear(), C.save(), d >= 0 && performance.mark("rive:align-renderer:start:f".concat(d)), this.alignRenderer(), d >= 0 && (performance.mark("rive:align-renderer:end:f".concat(d)), performance.measure("rive:align-renderer:f".concat(d), "rive:align-renderer:start:f".concat(d), "rive:align-renderer:end:f".concat(d))), d >= 0 && performance.mark("rive:artboard-draw:start:f".concat(d)), this.artboard.draw(C), d >= 0 && (performance.mark("rive:artboard-draw:end:f".concat(d)), performance.measure("rive:artboard-draw:f".concat(d), "rive:artboard-draw:start:f".concat(d), "rive:artboard-draw:end:f".concat(d))), C.restore(), d >= 0 && performance.mark("rive:renderer-flush:start:f".concat(d)), C.flush(), d >= 0 && (performance.mark("rive:renderer-flush:end:f".concat(d)), performance.measure("rive:renderer-flush:f".concat(d), "rive:renderer-flush:start:f".concat(d), "rive:renderer-flush:end:f".concat(d))), this._needsRedraw = !1), this.animator.handleLooping(), this.animator.handleStateChanges(), this.animator.handleAdvancing(s), this.frameCount++;
                var M = performance.now();
                for (this.frameTimes.push(M), this.durations.push(M - o); this.frameTimes[0] <= M - 1e3;) this.frameTimes.shift(), this.durations.shift();
                null == (r = this._viewModelInstance) || r.handleCallbacks(), this.animator.isPlaying ? this.scheduleRendering() : this.animator.isPaused ? this.lastRenderTime = 0 : this.animator.isStopped && (this.lastRenderTime = 0)
                ...
                var e, t;
                this.destroyed = !0, this.stopRendering(), this.cleanupInstances(), null !== this._observed && W.remove(this._observed), this.removeRiveListeners(), this.file && (null == (e = this.riveFile) || e.cleanup(), this.file = null), this.riveFile = null, this.deleteRiveRenderer(), null !== this._audioEventListener && (V.remove(this._audioEventListener), this._audioEventListener = null), null == (t = this._viewModelInstance) || t.cleanup(), this._viewModelInstance = null, this._dataEnums = null
                ...
                var n = this;
                (e = ea(e), this.readyForPlaying) ? (this.animator.play(e), this.eventCleanup && this.eventCleanup(), this.setupRiveListeners(), this.startRendering()) : this.taskQueue.add({
                    action: function() {
                        return n.play(e, t)
                    }
                })
                ...
                var t = this;
                (e = ea(e), this.readyForPlaying) ? (this.eventCleanup && this.eventCleanup(), this.animator.pause(e)) : this.taskQueue.add({
                    action: function() {
                        return t.pause(e)
                    }
                })
                ...
                var n = this;
                (e = ea(e), this.readyForPlaying) ? (this.animator.scrub(e, t || 0), this.drawFrame()) : this.taskQueue.add({
                    action: function() {
                        return n.scrub(e, t)
                    }
                })
                ...
                var t = this;
                (e = ea(e), this.readyForPlaying) ? (this.animator && this.animator.stop(e), this.eventCleanup && this.eventCleanup()) : this.taskQueue.add({
                    action: function() {
                        return t.stop(e)
                    }
                })
                ...
                set: function(e) {
                    this._volume = e, this.artboard && (this.artboard.volume = e * V.systemVolume)
                },
                enumerable: !1,
                configurable: !0
        ...
        }(), (z = u || (u = {})).none = "none", z.string = "string", z.number = "number", z.boolean = "boolean", z.color = "color", z.list = "list", z.enumType = "enumType", z.trigger = "trigger", z.viewModel = "viewModel", z.integer = "integer", z.listIndex = "listIndex", z.image = "image", z.artboard = "artboard", $ = function() {
            function e(e) {
                this._viewModel = e
            }
        ...
        }(), (Y = l || (l = {})).Number = "number", Y.String = "string", Y.Boolean = "boolean", Y.Color = "color", Y.Trigger = "trigger", Y.Enum = "enum", Y.List = "list", Y.Image = "image", Y.Artboard = "artboard", X = function() {
            function e(e, t) {
            ...
            return Object.defineProperty(e.prototype, "runtimeInstance", {
                ...
                switch (n) {
                    case l.Number:
                        if (null !== (C = null != (i = null == (r = this._runtimeInstance) ? void 0 : r.number(e[t])) ? i : null)) return new J(C, this);
                        break;
                    case l.String:
                        if (null !== (C = null != (o = null == (a = this._runtimeInstance) ? void 0 : a.string(e[t])) ? o : null)) return new q(C, this);
                        break;
                    case l.Boolean:
                        if (null !== (C = null != (u = null == (s = this._runtimeInstance) ? void 0 : s.boolean(e[t])) ? u : null)) return new K(C, this);
                        break;
                    case l.Color:
                        if (null !== (C = null != (h = null == (c = this._runtimeInstance) ? void 0 : c.color(e[t])) ? h : null)) return new et(C, this);
                        break;
                    case l.Trigger:
                        if (null !== (C = null != (d = null == (f = this._runtimeInstance) ? void 0 : f.trigger(e[t])) ? d : null)) return new Z(C, this);
                        break;
                    case l.Enum:
                        if (null !== (C = null != (v = null == (p = this._runtimeInstance) ? void 0 : p.enum(e[t])) ? v : null)) return new Q(C, this);
                        break;
                    case l.List:
                        if (null !== (C = null != (b = null == (m = this._runtimeInstance) ? void 0 : m.list(e[t])) ? b : null)) return new ee(C, this);
                        break;
                    case l.Image:
                        if (null !== (C = null != (y = null == (g = this._runtimeInstance) ? void 0 : g.image(e[t])) ? y : null)) return new en(C, this);
                        break;
                    case l.Artboard:
                        if (null !== (C = null != (_ = null == (w = this._runtimeInstance) ? void 0 : w.artboard(e[t])) ? _ : null)) return new er(C, this)
                }
                return null
                ...
                if (null !== r) {
                    var i = new e(r, this);
                    return (0, f.createFinalization)(i, r), i.internalIncrementReferenceCount(), this._viewModelInstances.set(t, i), i
                }
                return null
            ...
            return p(t, e), Object.defineProperty(t.prototype, "value", {
                set: function(e) {
                    var t, n, r;
                    r = e.isBindableArtboard ? e : e.file.internalBindableArtboardFromArtboard(e.nativeArtboard), this._viewModelInstanceValue.value(null != (t = null == r ? void 0 : r.nativeArtboard) ? t : null), (null == r ? void 0 : r.nativeViewModel) && this._viewModelInstanceValue.viewModelInstance(null != (n = null == r ? void 0 : r.nativeViewModel) ? n : null)
                },
                enumerable: !1,
                configurable: !0
            }), t.prototype.internalHandleCallback = function(e) {
    ...
    function v(e) {
        var t, n, r, a, o, u, l, d = e.riveLoaded,
            v = void 0 !== d && d,
            m = e.canvasElem,
            b = e.containerRef,
            g = e.options,
            y = e.onCanvasHasResized,
            w = e.artboardBounds,
            _ = p(void 0 === g ? {} : g),
            A = i.useState({
                height: 0,
            ...
            O = L[0],
            x = L[1],
            j = _.fitCanvasToArtboardHeight,
            S = _.shouldResizeCanvasToContainer,
            V = _.useDevicePixelRatio,
            D = _.customDevicePixelRatio,
            B = (void 0 === (t = S) && (t = !0), r = (n = i.useState({
                width: 0,
                height: 0
            }))[0], a = n[1], i.useEffect(function() {
                if ("u" > typeof window && t) {
                    ...
                    return f && (e(), window.addEventListener("resize", e)),
                        function() {
                ...
                clearTimeout(u), u = window.setTimeout(function() {
                    return o.apply(e, n)
                }, 0)
                ...
                return b.current && h && e.observe(b.current),
                    function() {
                        e.disconnect(), n && h && e.unobserve(n)
                    }
            }, [b, l]), r),
            W = s(D),
            U = null != w ? w : {},
            ...
            $ = i.useCallback(function() {
                var e, t, n, r, i = null != (e = null == (n = b.current) ? void 0 : n.clientWidth) ? e : 0,
                    a = null != (t = null == (r = b.current) ? void 0 : r.clientHeight) ? t : 0;
                return j && w ? {
                    width: i,
        ...
        i.useEffect(function() {
            if (S && b.current && v) {
                ...
                if (m) {
                    var i = t !== P || n !== M;
                    if (_.fitCanvasToArtboardHeight && i && (b.current.style.height = n + "px", r = !0), _.useDevicePixelRatio) {
                        var a = t * W !== F || n * W !== k;
                        if (i || a) {
                            var o = W * t,
                                s = W * n;
                            m.width = o, m.height = s, m.style.width = t + "px", m.style.height = n + "px", T({
                                width: o,
                                height: s
                            }), r = !0
                        }
                    } else i && (m.width = t, m.height = n, T({
                        width: t,
                        height: n
                    }), r = !0);
                    R({
        ...
        }, [m, b, B, W, $, O, x, k, F, M, P, y, S, j, V, v]), i.useEffect(function() {
            T({
                width: 0,
                height: 0
            })
    ...
    function C(e, t) {
            ...
            C = i.useCallback(function() {
                if (f) {
                    if (f.layout && f.layout.fit === a.Fit.Layout && r) {
                        ...
                        f.devicePixelRatioUsed = g, f.artboardWidth = (null == r ? void 0 : r.width) / e, f.artboardHeight = (null == r ? void 0 : r.height) / e
                    }
        ...
        var M = i.useCallback(function(e) {
            null === e && r && (r.height = 0, r.width = 0), u(e)
        }, []);
        i.useEffect(function() {
            if (r && e) {
                var t, n = null != f;
                if (null == f) {
                    ...
                    t = new a.Rive(w({
                        ...
                        canvas: r
                    })), null != c.current && c.current.cleanup(), c.current = t, t.on(a.EventType.Load, function() {
                        n = !0, o && o(t), r ? d(t) : t.cleanup()
                    })
                }
                return function() {
                    n || null == t || t.cleanup()
        ...
        }, [E, I, f, r, b.shouldUseIntersectionObserver]), i.useEffect(function() {
            return function() {
                f && (f.cleanup(), d(null))
            }
        }, [f, r]), i.useEffect(function() {
            return function() {
        ...
        i.useEffect(function() {
            f && k && (f.isPlaying ? (f.stop(f.animationNames), f.play(k)) : f.isPaused && (f.stop(f.animationNames), f.pause(k)))
        }, [k, f]);
    ...
    function P(e, t, n) {
        ...
        var m = i.useCallback(function() {
            var e = d.current,
                t = p.current,
                n = v.current;
            if (!e || !t) return o(null), l(n.defaultValue), f(null),
                function() {};
            var r = n.getProperty(e, t);
            if (r) {
                o(r), l(n.getValue(r)), n.getExtendedData && f(n.getExtendedData(r));
                var i = function() {
                    l(n.getValue(r)), n.getExtendedData && f(n.getExtendedData(r)), n.onPropertyEvent && n.onPropertyEvent()
                };
                return r.on(i),
                    function() {
                        r.off(i)
        ...
        i.useEffect(function() {
            return d.current = t, p.current = e, m()
        }, [t, e, m]);
        var b = i.useCallback(function(e) {
                if (a && d.current === t) try {
                    e(a), v.current.getExtendedData && f(v.current.getExtendedData(a));
                    return
                } catch (e) {}
                if (d.current) try {
                    var n = v.current.getProperty(d.current, p.current);
                    n && (o(n), e(n), v.current.getExtendedData && f(v.current.getExtendedData(n)))
                } catch (e) {}
            }, [a, t]),
        ...
        return n.getExtendedData && (y.extendedData = h), y
    }
    ...
    n.default = function(e) {
    ...
    }, n.useResizeCanvas = v, n.useRive = C, n.useRiveFile = function(e) {
        ...
        return i.useEffect(function() {
            ...
            return (t = function() {
                    return function(e, t) {
                        ...
                        try {
                            u("loading"), (n = new a.RiveFile(e)).init(), n.on(a.EventType.Load, function() {
                                null == n || n.getInstance(), r(n), u("success")
            ...
            var i = function() {
                if (e && t && n || u(null), e && t && n) {
                    ...
                    if (i) {
                        ...
                        void 0 !== r && a && (a.value = r), u(a || null)
                    }
                } else u(null)
            };
            i(), e && e.on(a.EventType.Load, function() {
                i()
            })
        }, [e]), s
        ...
        return i.useEffect(function() {
            ...
            var t = null;
            f(t = null != r ? e.instanceByName(r) || null : o ? (null == e.defaultInstance ? void 0 : e.defaultInstance.call(e)) || null : u ? (null == e.instance ? void 0 : e.instance.call(e)) || null : (null == e.defaultInstance ? void 0 : e.defaultInstance.call(e)) || null), l && t && l.viewModelInstance !== t && l.bindViewModelInstance(t)
        }, [e, r, o, u, l]), h
    ...
    var t = e.i(43476),
        ...
        a = e.i(78530);
    let o = (e, t) => {
        let i, o, s, u, l, c, h = (0, n.c)(16);
        h[0] !== t ? (i = void 0 === t ? {} : t, h[0] = t, h[1] = i) : i = h[1];
        let {
            autoLoad: f
        } = i, d = void 0 === f || f;
        h[2] !== e ? (o = () => (0, a.getCachedRiveBuffer)(e), h[2] = e, h[3] = o) : o = h[3];
        let [p, v] = (0, r.useState)(o), [m, b] = (0, r.useState)(!p), [g, y] = (0, r.useState)(null);
        h[4] !== e ? (s = () => {
            let t = (0, a.getCachedRiveBuffer)(e);
            if (t) {
                v(t), b(!1);
                return
            }
            b(!0), y(null), (0, a.loadRiveBuffer)(e).then(e => {
                v(e), b(!1)
            }).catch(e => {
                y(e), b(!1)
            })
        ...
        return h[6] !== d || h[7] !== p || h[8] !== w ? (u = () => {
            d && !p && w()
        }, l = [d, w, p], h[6] = d, h[7] = p, h[8] = w, h[9] = u, h[10] = l) : (u = h[9], l = h[10]), (0, r.useEffect)(u, l), h[11] !== p || h[12] !== g || h[13] !== m || h[14] !== w ? (c = {
            buffer: p,
            isLoading: m,
            error: g,
            load: w
        }, h[11] = p, h[12] = g, h[13] = m, h[14] = w, h[15] = c) : c = h[15], c
    };
    ...
    e.s(["default", 0, e => {
        let l, c, h, f, d, p, v = (0, n.c)(13),
            ...
            {
                buffer: g
            } = o(a.RIVE_ANIMATIONS.GENERAL_LOADING);
        v[0] !== g ? (l = g ? {
            buffer: g,
            autoplay: !0,
            layout: u
        } : null, v[0] = g, v[1] = l) : l = v[1];
        let {
            rive: y,
            RiveComponent: w
        } = (0, i.useRive)(l);
        v[2] !== y ? (c = () => () => y ? .cleanup(), h = [y], v[2] = y, v[3] = c, v[4] = h) : (c = v[3], h = v[4]), (0, r.useEffect)(c, h);
        let _ = y || void 0 !== b && b ? "opacity-100" : "opacity-0";
        return v[5] !== m || v[6] !== _ ? (f = (0, s.cls)("w-35 md:w-10 aspect-square", m, _), v[5] = m, v[6] = _, v[7] = f) : f = v[7], v[8] !== w ? (d = (0, t.jsx)(w, {}), v[8] = w, v[9] = d) : d = v[9], v[10] !== f || v[11] !== d ? (p = (0, t.jsx)("div", {
            className: f,
            children: d
        }), v[10] = f, v[11] = d, v[12] = p) : p = v[12], p
    }], 19599)
}]);