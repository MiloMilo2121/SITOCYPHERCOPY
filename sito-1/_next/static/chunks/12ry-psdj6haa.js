(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 78530, e => {
    ...
    let t = new Map,
        ...
        r = e => {
            ...
            let l = i.get(e);
            if (l) return l;
            let a = fetch(e).then(t => {
                if (!t.ok) throw Error(`Failed to load Rive file: ${e}`);
                return t.arrayBuffer()
            }).then(r => (t.set(e, r), i.delete(e), r)).catch(t => {
                throw i.delete(e), t
            });
            return i.set(e, a), a
        },
    ...
    }, "getCachedRiveBuffer", 0, e => t.get(e) ? ? null, "loadRiveBuffer", 0, r, "preloadRiveFiles", 0, l])
}, 90392, e => {
    "use strict";
    var t = e.i(43476),
        i = e.i(71645),
    ...
    e.s(["default", 0, function() {
        let e = (0, l.useUIStore)(e => e.skipLoadingAnimation),
            a = (0, l.useUIStore)(e => e.setSkipLoadingAnimation),
            s = (0, i.useRef)(e);
        return ((0, i.useEffect)(() => {
            s.current && a(!1)
        }, [a]), s.current) ? (0, t.jsx)("div", {
