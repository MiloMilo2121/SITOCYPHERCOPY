(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 75254, e => {
    ...
    let n = (0, t.forwardRef)(({
        ...
        height: i,
        stroke: e,
        strokeWidth: r ? 24 * Number(n) / Number(i) : n,
    ...
    let n = (0, i.forwardRef)(({
        ...
        disabled: d || u,
        onMouseEnter: c,
        className: (0, o.cls)("button text-sm font-medium outline-none focus:outline-none focus-visible:outline-none transition-all duration-200", r, n, i, (d || u) && "opacity-50 select-none pointer-events-none"),
        onClick: l,
    ...
    var t = e.i(43476),
        ...
        o = e.i(75157);
    e.s(["default", 0, e => {
        let n, r, s, l, c, d, u, m, p, h = (0, i.c)(16);
        h[0] !== e ? ({
            children: n,
            className: l,
            animationType: c,
            style: s,
            ...r
        } = e, h[0] = e, h[1] = n, h[2] = r, h[3] = s, h[4] = l, h[5] = c) : (n = h[1], r = h[2], s = h[3], l = h[4], c = h[5]);
        let f = void 0 === l ? "flex flex-col gap-5 w-full h-fit" : l,
            g = void 0 === c ? "full" : c,
            [y, b] = (0, a.useState)("full" === g ? "animation-container" : "animation-container-fade"),
            v = (0, a.useRef)(!1);
        ...
        }, u = [], h[6] = d, h[7] = u) : (d = h[6], u = h[7]), (0, a.useEffect)(d, u), h[8] !== y || h[9] !== f ? (m = (0, o.cls)(f, y), h[8] = y, h[9] = f, h[10] = m) : m = h[10], h[11] !== n || h[12] !== r || h[13] !== s || h[14] !== m ? (p = (0, t.jsx)("div", {
            className: m,
            style: s,
            ...r,
            children: n
        }), h[11] = n, h[12] = r, h[13] = s, h[14] = m, h[15] = p) : p = h[15], p
    }])
}, 62788, e => {
    "use strict";
    ...
    e.s(["default", 0, e => {
        ...
        if (c[0] === Symbol.for("react.memo_cache_sentinel") ? (n = () => (f(!0), () => f(!1)), r = [], c[0] = n, c[1] = r) : (n = c[0], r = c[1]), (0, a.useEffect)(n, r), !h || !g) return null;
        c[2] !== d || c[3] !== p || c[4] !== m ? (s = p || m ? (0, t.jsx)("div", {
            id: m,
            className: p,
            children: d
        }) : d, c[2] = d, c[3] = p, c[4] = m, c[5] = s) : s = c[5];
        let y = s;
    ...
    e.s(["default", 0, () => {
        let e, f, g, y, b, v, w, x, S, N, C, k, P, M, j = (0, i.c)(23),
            A = (0, c.usePathname)(),
            T = (0, u.useMaintenanceStore)(h),
            [_, I] = (0, a.useState)(!1),
            [E, U] = (0, a.useState)(!1);
        j[0] === Symbol.for("react.memo_cache_sentinel") ? (e = (0, d.isMaintenanceMode)(), j[0] = e) : e = j[0];
        let O = e;
        j[1] === Symbol.for("react.memo_cache_sentinel") ? (f = () => {
            I(!1), U(!1)
        }, j[1] = f) : f = j[1], j[2] !== A ? (g = [A, O], j[2] = A, j[3] = g) : g = j[3], (0, a.useEffect)(f, g), j[4] === Symbol.for("react.memo_cache_sentinel") ? (y = () => {
            U(!0), setTimeout(() => I(!0), 300)
        }, j[4] = y) : y = j[4];
        let G = y;
        j[5] !== T ? (b = () => {
            T()
        ...
        let R = b,
            L = A ? .startsWith("/preview/");
        if (!O || _ || L) return null;
        let D = E ? "opacity-0 translate-y-2" : "opacity-100 translate-y-0";
        return j[7] !== D ? (v = (0, m.cls)("fixed bottom-5 left-5 right-5 md:left-auto md:right-5 z-9999 transition-all duration-300", D), j[7] = D, j[8] = v) : v = j[8], j[9] !== R ? (w = (0, t.jsx)(s.default, {
            onClick: e => {
                e.stopPropagation(), R()
            },
            className: "h-8 w-full text-xs",
            children: p.UI_STRINGS.notifications.maintenance.learnMore
        }), j[9] = R, j[10] = w) : w = j[10], j[11] === Symbol.for("react.memo_cache_sentinel") ? (x = e => {
            e.stopPropagation(), G()
        }, j[11] = x) : x = j[11], j[12] === Symbol.for("react.memo_cache_sentinel") ? (S = (0, t.jsx)(s.default, {
        ...
        }), j[12] = S) : S = j[12], j[13] !== w ? (N = (0, t.jsxs)("div", {
            ...
            children: [w, S]
        }), j[13] = w, j[14] = N) : N = j[14], j[15] === Symbol.for("react.memo_cache_sentinel") ? (C = (0, t.jsx)("div", {
            className: "relative h-8 flex items-center justify-center rounded card aspect-square px-0",
            children: (0, t.jsx)(o.Info, {
                className: "relative size-4/10 text-black"
            })
        }), j[15] = C) : C = j[15], j[16] === Symbol.for("react.memo_cache_sentinel") ? (k = (0, t.jsx)("div", {
        ...
        }), j[16] = k) : k = j[16], j[17] !== R || j[18] !== N ? (P = (0, t.jsxs)("div", {
            onClick: R,
            className: "relative w-full md:w-20 cursor-pointer group transition-all duration-200 hover:-translate-y-[3px]",
            role: "alert",
            "aria-live": "polite",
            children: [N, k]
        }), j[17] = R, j[18] = N, j[19] = P) : P = j[19], j[20] !== P || j[21] !== v ? (M = (0, t.jsx)(r.default, {
            children: (0, t.jsx)(l.default, {
                className: v,
                children: P
            })
        }), j[20] = P, j[21] = v, j[22] = M) : M = j[22], M
    }])
}, 24989, e => {
    e.n(e.i(96833))
}]);