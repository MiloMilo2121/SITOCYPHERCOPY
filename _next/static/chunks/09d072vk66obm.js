(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 30013, 84593, 29213, e => {
    ...
    function w(e, t, n) {
        let r, i, E, S, D, O, A, P, T = e.ownerDocument,
            L = T.defaultView,
            F = function(e) {
                function t(e, t) {
            ...
            I = (i = {}, E = {
                ...
                emit: function(e) {
                    return (i[e] || []).forEach(t => t(r, e)), E
                },
                off: function(e, t) {
                    return i[e] = (i[e] || []).filter(e => e !== t), E
                },
                on: function(e, t) {
                    return i[e] = (i[e] || []).concat([t]), E
                },
                clear: function() {
                    i = {}
                }
            ...
            H = !1,
            X = V(M, w.globalOptions),
            W = V(X),
            Y = [];

        function U(t, n) {
            H || (W = C(X = V(X, t)), Y = n || Y, function() {
                let {
                    container: t,
                    slides: n
                } = W;
                ...
                let r = function(e, t, n, r, i, c, M) {
                    var w, E;
                    let S, D, O, A, P, T, L, F, j, k, I, V, C, N, {
                            align: z,
                            axis: R,
                            direction: B,
                            startIndex: H,
                        ...
                        et = ee.measure(t),
                        en = n.map(ee.measure),
                        er = (D = "rtl" === B, A = (O = "y" === R) || !D ? 1 : -1, P = O ? "top" : D ? "right" : "left", T = O ? "bottom" : D ? "left" : "right", {
                            scroll: O ? "y" : "x",
                            cross: O ? "x" : "y",
                            startEdge: P,
                            endEdge: T,
                        ...
                        ea = !X && !!J,
                        {
                            ...
                            let {
                                ...
                                startEdge: a,
                                endEdge: c
                            } = e, l = n[0] && i, f = function() {
                                if (!l) return 0;
                                let e = n[0];
                                return s(t[a] - e[a])
                            }(), p = l ? parseFloat(o.getComputedStyle(d(r)).getPropertyValue(`margin-${c}`)) : 0, g = n.map(u), h = n.map((e, t, n) => {
                                let r = t === m(n);
                                ...
                                groupSlides: function(e) {
                                    return h ? f(e).filter(e => e % n == 0).map(t => e.slice(t, t + n)) : e.length ? f(e).reduce((n, o, f) => {
                                        let h = d(n) || 0,
                                            ...
                                            y = r || 0 !== h ? 0 : g(a),
                                            M = s(x - (!r && v ? g(c) : 0) - (b + y));
                                        return f && M > t + 2 && n.push(o), v && n.push(e.length), n
                                    }, []).map((t, n, r) => {
                        ...
                        }(er, ei, q, X, et, en, el, ef),
                        {
                            ...
                            let {
                                ...
                                groupSlides: a
                            } = i, c = a(r).map(e => d(e)[u] - e[0][o]).map(s).map(t.measure), l = r.map(e => n[o] - e[o]).map(e => -s(e)), f = a(l).map(e => e[0]).map((e, t) => e + c[t]);
                            return {
                                snaps: l,
                                snapsAligned: f
                            }
                        ...
                        eg = -d(em) + d(es),
                        {
                            ...
                            let i, o, u = b(-t + e, 0),
                                ...
                                c = (i = a[0], o = d(a), b(a.lastIndexOf(i), a.indexOf(o) + 1));
                            return {
                        ...
                        eE = function(e, t, n, r) {
                            ...
                            function s(e) {
                                ...
                                u || (u = e, n(), n());
                                let i = e - u;
                                for (u = e, a += i; a >= o;) n(), a -= o;
                                r(a / o), c && (c = t.requestAnimationFrame(s))
                            }

                            function l() {
                                t.cancelAnimationFrame(c), u = null, a = 0, c = 0
                            }
                            return {
                                init: function() {
                            ...
                            r.set(v), f && (o.loop(e.direction()), u.loop()), t.to(r.get()), h && s.emit("settle"), g || s.emit("scroll")
                        })(eN, e)),
                        eS = eb[ey.get()],
                        eD = x(eS),
                        eO = x(eS),
                        ...
                        eT = function(e, t, n, r, i) {
                            ...
                            let g = {
                                ...
                                seek: function() {
                                    let t = r.get() - e.get(),
                                        i = 0;
                                    return a ? (n.set(e), o += t / a, o *= c, f += o, e.add(o), i = f - d) : (o = 0, n.set(r), e.set(r), i = t), u = l(i), d = f, g
                                },
                                settled: function() {
                        ...
                        eF = function(e, t, n, r, i, o, u) {
                            function a(i) {
                                let a = i.distance,
                                    c = i.index !== t.get();
                                o.add(a), a && (r.duration() ? e.start() : (e.update(), e.render(1), e.update())), c && (n.set(t.get()), t.set(i.index), u.emit("select"))
                            }
                            return {
                        ...
                        ek = v(),
                        eI = (j = {}, k = null, I = null, V = !1, {
                            init: function() {
                                F = new IntersectionObserver(e => {
                                    V || (e.forEach(e => {
                                        j[n.indexOf(e.target)] = e
                                    }), k = null, I = null, M.emit("slidesInView"))
                                }, {
                        ...
                        }),
                        {
                            ...
                            return {
                                slideRegistry: (u = a(o), 1 === n.length ? [o] : e && "keepSnaps" !== t ? u.slice(c, s).map((e, t, n) => {
                                    let r = t === m(n);
                                    return t ? r ? p(m(o) - d(n)[0] + 1, d(n)[0]) : e : p(d(n[0]) + 1)
                                }) : u)
                            }
                        }(ea, J, eb, ev, ed, ew),
                        eC = function(e, t, n, r, i, u, c, s) {
                            let l = {
                                    passive: !0,
                                    capture: !0
                                },
                        ...
                        eN = {
                            ...
                            dragHandler: function(e, t, n, r, i, o, u, c, f, d, m, p, g, x, y, M, w, E) {
                                let {
                                    ...
                                    passive: !1
                                }, P = v(), T = v(), L = b(50, 225).constrain(x.measure(20)), F = {
                                    mouse: 300,
                                    touch: 400
                                }, j = {
                                    mouse: 500,
                                    touch: 600
                                }, k = y ? 43 : 25, I = !1, V = 0, C = 0, N = !1, z = !1, R = !1, B = !1;

                                function H(e) {
                                    if (!h(e, r) && e.touches.length >= 2) return X(e);
                                    let t = o.readPoint(e),
                                        n = o.readPoint(e, S),
                                        u = s(t - V),
                                        a = s(n - C);
                                    if (!z && !B && (!e.cancelable || !(z = u > a))) return X(e);
                                    let l = o.pointerMove(e);
                                    u > M && (R = !0), d.useFriction(.3).useDuration(.75), c.start(), i.add(D(l)), e.preventDefault()
                                }

                                function X(e) {
                                    var t;
                                    let n, r, i = m.byDistance(0, !1).index !== p.get(),
                                        u = o.pointerUp(e) * (y ? j : F)[B ? "mouse" : "touch"],
                                        a = (t = D(u), n = p.add(-1 * l(t)), r = m.byDistance(t, !y).distance, y || s(t) < L ? r : w && i ? .5 * r : m.byIndex(n.get(), 0).distance),
                                        c = function(e, t) {
                                            var n, r;
                                            if (0 === e || 0 === t || s(e) <= s(t)) return 0;
                                            let i = (n = s(e), r = s(t), s(n - r));
                                            return s(i / e)
                                        }(u, a);
                                    z = !1, N = !1, T.clear(), d.useDuration(k - 10 * c).useFriction(.68 + c / 50), f.distance(a, !y), B = !1, g.emit("pointerUp")
                                }
                                    ...
                                    init: function(e) {
                                        ...
                                        function c(c) {
                                            (a(E) || E(e, c)) && function(e) {
                                                let a, c = h(e, r);
                                                if ((B = c, R = y && c && !e.buttons && I, I = s(i.get() - u.get()) >= 2, !c || 0 === e.button) && (a = e.target.nodeName || "", !O.includes(a))) {
                                                    let r;
                                                    N = !0, o.pointerDown(e), d.useFriction(0).useDuration(0), i.set(u), r = B ? n : t, T.add(r, "touchmove", H, A).add(r, "touchend", X).add(r, "mousemove", H, A).add(r, "mouseup", X), V = o.readPoint(e), C = o.readPoint(e, S), g.emit("pointerDown")
                                                }
                                            }(c)
                                        }
                                    },
                            ...
                            resizeHandler: function(e, t, n, r, i, o, u) {
                                ...
                                return {
                                    init: function(i) {
                                        o && (l = p(e), d = r.map(p), c = new ResizeObserver(n => {
                                ...
                                return {
                                    ...
                                    constrain: function(i) {
                                        ...
                                        let c = e.reachedMin(t.get()) ? "min" : "max",
                                            ...
                                            d = n.get() - t.get(),
                                            m = a.constrain(f / u);
                                        n.subtract(d * m), !i && s(d) < o && (n.set(e.constrain(n.get())), r.useDuration(25).useBaseFriction())
                                    },
                                    toggleActive: function(e) {
                                        c = !e
                                    }
                ...
                options: e
            }) => e)]).forEach(e => k.add(e, "change", $)), W.active && (S.translate.to(S.location.get()), S.animation.init(), S.slidesInView.init(), S.slideFocus.init(K), S.eventHandler.init(K), S.resizeHandler.init(K), S.slidesHandler.init(K), S.options.loop && S.slideLooper.loop(), O.offsetParent && A.length && S.dragHandler.init(K), D = j.init(K, Y)))
        }
        ...
        function q() {
            S.dragHandler.destroy(), S.eventStore.clear(), S.translate.clear(), S.slideLooper.clear(), S.resizeHandler.destroy(), S.slidesHandler.destroy(), S.slidesInView.destroy(), S.animation.destroy(), j.destroy(), k.clear()
        }

        function G(e, t, n) {
            W.active && !H && (S.scrollBody.useBaseFriction().useDuration(!0 === t ? 0 : W.duration), S.scrollTo.index(e, n || 0))
        }
        ...
        let K = {
            ...
            destroy: function() {
                H || (H = !0, k.clear(), q(), I.emit("destroy"), I.clear())
            },
            off: R,
            on: z,
            emit: B,
        ...
        return U(t, n), setTimeout(() => I.emit("init"), 0), K
    }
    ...
    w.globalOptions = void 0, E.globalOptions = void 0, e.s(["default", 0, E], 30013), e.i(47167);
        ...
        var t, n, r, i, o, u = function() {
            ...
            v = function(e) {
                var t, n, r, o, u = (o = function(e, t) {
                    ...
                    }((t = e.deltaX * P[e.deltaMode], n = e.deltaY * P[e.deltaMode], r = (e.deltaZ || 0) * P[e.deltaMode], {
                    ...
                    c = u.timeStamp,
                    s = O(a);
                if (e.preventDefault && h(s, a) && e.preventDefault(), f.isStarted ? f.isMomentum && s > Math.max(2, 2 * f.lastAbsDelta) && (V(!0), k()) : k(), 0 === s && Object.is && Object.is(e.deltaX, -0)) {
                    d = !0;
                    return
                }
                i = e, f.axisMovement = D(f.axisMovement, a), f.lastAbsDelta = s, f.scrollPointsToMerge.push({
                    axisDelta: a,
                    timeStamp: c
                }), b(), g({
                    axisDelta: a,
                    isStart: !f.isStartPublished
                }), f.isStartPublished = !0, I()
            },
            b = function() {
                if (2 === f.scrollPointsToMerge.length) {
                    ...
                    }), y(), f.scrollPointsToMerge.length = 0, f.scrollPoints.length = 1, f.isMomentum || E()
                } else f.isStartPublished || x()
            },
            x = function() {
                var e;
            ...
            y = function() {
                ...
                if (n && t) {
                    ...
                    f.axisVelocity = i, f.accelerationFactors.push(o), M(r)
                }
            },
            M = function(e) {
                var t = 10 * Math.ceil(e / 10) * 1.2;
                f.isMomentum || (t = Math.max(100, 2 * t)), f.willEndTimeout = Math.min(1e3, Math.round(t))
            },
            w = function(e) {
                return 0 === e || e <= .96 && e >= .6
            },
            E = function() {
                if (f.accelerationFactors.length >= 5) {
                    if (d && (d = !1, O(f.axisVelocity) >= .2)) return void j();
            ...
            k = function() {
                (f = F()).isStarted = !0, f.startTime = Date.now(), o = void 0, d = !1
            },
            I = function() {
                clearTimeout(t), t = setTimeout(V, f.willEndTimeout)
            },
            V = function(e) {
                void 0 === e && (e = !1), f.isStarted && (f.isMomentum && e ? g({
                    isEnding: !0,
                    isMomentumCancel: !0
                }) : g({
                    isEnding: !0
                }), f.isMomentum = !1, f.isStarted = !1)
            },
            C = (n = [], A({
                observe: function(e) {
                ...
                unobserve: r = function(e) {
                    e.removeEventListener("wheel", m), n = n.filter(function(t) {
                        return t !== e
                    })
                },
                disconnect: function() {
    ...
    function I(e) {
        ...
        return {
            ...
            options: e,
            init: function(r, i) {
                var o, u, a, c = i.mergeOptions,
                    s = i.optionsAtMedia,
                    l = c(k, I.globalOptions);
                t = s(c(l, e));
                ...
                var h = p.observe(d),
                    v = p.on("wheel", function(e) {
                        ...
                        !(Math.abs(u) > Math.abs(c)) || b || e.isMomentum || M || function(e) {
                            try {
                                a = new MouseEvent("mousedown", e.event), O(a)
                            } catch (e) {
                                return n()
                            }
                            b = !0, x = 0, document.documentElement.addEventListener("mousemove", S, !0), document.documentElement.addEventListener("mouseup", S, !0), document.documentElement.addEventListener("mousedown", S, !0), t.wheelDraggingClass && d.classList.add(t.wheelDraggingClass)
                        }(e), M && e.isEnding && (M = !1), b && ! function(e) {
                            var t = A(e),
                                n = t.isAtBoundary,
                                r = t.primaryAxisDelta;
                            if (n && !e.isMomentum) {
                                if ((x += Math.abs(r)) > y) return M = !0, w(e), !0
                            } else x = 0;
                            return !1
                ...
                function w(e) {
                    b = !1, O(D("mouseup", e)), E(), t.wheelDraggingClass && d.classList.remove(t.wheelDraggingClass)
                }
                ...
                function D(e, t) {
                    ...
                    if (!f.options.skipSnaps && !f.options.dragFree) {
                        ...
                        n = n < 0 ? Math.max(n, -s) : Math.min(n, s), r = r < 0 ? Math.max(r, -l) : Math.min(r, l)
                    }
                ...
                g(), r.on("resize", g), n = function() {
                    h(), v(), r.off("resize", g), E()
                }
            },
            destroy: function() {
                return n()
    ...
    I.globalOptions = void 0, e.s(["WheelGesturesPlugin", 0, I], 84593);
    var V = e.i(932);
    e.s(["useWheelDirectionLock", 0, e => {
        ...
        i[0] !== e ? (n = () => {
            ...
            let t = e.rootNode(),
                n = e => {
                    if (u.current && clearTimeout(u.current), u.current = setTimeout(() => {
                            o.current = null
                        }, 50), !o.current) {
                    ...
                    "y" === o.current && e.stopPropagation(), "x" === o.current && e.preventDefault()
                };
        ...
        }, r = [e], i[0] = e, i[1] = n, i[2] = r) : (n = i[1], r = i[2]), (0, t.useEffect)(n, r)
    }], 29213)
}]);