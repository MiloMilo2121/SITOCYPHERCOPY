(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 33917, e => {
    "use strict";
    let t;
    var n, r = e.i(65389),
        o = e.i(41383);
    let l = e => {
        (0, o.isDevelopmentEnvironment)() && console.error(`Clerk: ${e}`)
    };
    var i = e.i(71645),
        a = e.i(74080);
    let u = (e, ...t) => {
    ...
    var s = e.i(27085),
        d = new Map,
        p = e => {
            let [t, n] = (0, i.useState)(new Map);
            return e.map(e => ({
                id: e.id,
                mount: t => n(n => new Map(n).set(String(e.id), t)),
                unmount: () => n(t => {
                    let n = new Map(t);
                    return n.set(String(e.id), null), n
                }),
                portal: () => {
                    let n = t.get(String(e.id));
                    return n ? (0, a.createPortal)(e.component, n) : null
                }
            }))
        },
        ...
        g = (e, t) => {
            let {
                ...
                LinkComponent: o,
                PageComponent: a,
                MenuItemsComponent: u,
                reorderItemsLabels: s,
                componentName: d
            } = e, {
                allowForAnyChildren: m = !1
            } = t || {}, f = [];
            i.default.Children.forEach(n, e => {
                if (!c(e, a) && !c(e, o) && !c(e, u)) {
                    e && !m && l((0, r.customPagesIgnoredComponent)(d));
                    return
                }
                let {
                    props: t
                ...
                if (c(e, a))
                    if (P(t, s)) f.push({
                        ...
                        if (!v(t)) return void l((0, r.customPageWrongProps)(d));
                        f.push({
                            label: i,
                            labelIcon: h,
                            children: n,
                ...
                if (c(e, o))
                    if (!C(t)) return void l((0, r.customLinkWrongProps)(d));
                    else f.push({
                        label: i,
                        labelIcon: h,
                        url: p
        ...
        }).isReady, e => new Promise((r, o) => {
            let {
                root: l = null == document ? void 0 : document.body,
                selector: i,
                timeout: a = 0
            } = e;
            if (!l) return void o(Error("No root element provided"));
            let u = l;
            if (i && (u = null == l ? void 0 : l.querySelector(i)), t(u, i)) return void r();
            let s = new MutationObserver(e => {
                for (let o of e)
                    if (!u && i && (u = null == l ? void 0 : l.querySelector(i)), (n.childList && "childList" === o.type || n.attributes && "attributes" === o.type) && t(u, i)) {
                        s.disconnect(), r();
                        return
                    }
            });
            s.observe(l, n), a > 0 && setTimeout(() => {
                s.disconnect(), o(Error(`Timeout waiting for ${i}`))
            }, a)
        }));

    function _(e, t) {
        let n = (0, i.useRef)(),
            [r, o] = (0, i.useState)("rendering");
        ...
        }, [e, null == t ? void 0 : t.selector]), r
    }
    var w = e => null == e ? void 0 : e.map(({
            mountIcon: e,
            unmountIcon: t,
            ...n
        }) => n),
        A = class extends i.default.PureComponent {
            constructor() {
                super(...arguments), this.rootRef = i.default.createRef()
            }
            componentDidUpdate(e) {
                ...
                (!(0, s.isDeeplyEqual)(l, i) || !(0, s.isDeeplyEqual)(p, c) || a || d) && this.rootRef.current && this.props.updateProps({
                    node: this.rootRef.current,
                    props: this.props.props
                })
            }
            componentDidMount() {
                this.rootRef.current && ("mount" in this.props && this.props.mount(this.rootRef.current, this.props.props), "open" in this.props && this.props.open(this.props.props))
            }
            componentWillUnmount() {
                this.rootRef.current && ("mount" in this.props && this.props.unmount(this.rootRef.current), "open" in this.props && this.props.close())
            }
            render() {
                let {
                ...
                return i.default.createElement(i.default.Fragment, null, !e && i.default.createElement("div", { ...t
                }), this.props.children)
            }
        },
        I = e => {
            var t, n;
            return i.default.createElement(i.default.Fragment, null, null == (t = null == e ? void 0 : e.customPagesPortals) ? void 0 : t.map((e, t) => (0, i.createElement)(e, {
                key: t
            })), null == (n = null == e ? void 0 : e.customMenuItemsPortals) ? void 0 : n.map((e, t) => (0, i.createElement)(e, {
                key: t
            })))
        },
        S = (0, r.withClerk)(({
            ...
            return i.default.createElement(i.default.Fragment, null, o && n, e.loaded && i.default.createElement(A, {
                component: t,
                mount: e.mountSignIn,
    ...
    function T({
        ...
        return l(r.userProfilePageRenderedError), i.default.createElement(i.default.Fragment, null, e)
    }

    function L({
        children: e
    }) {
        return l(r.userProfileLinkRenderedError), i.default.createElement(i.default.Fragment, null, e)
    }
    var O = Object.assign((0, r.withClerk)(({
            clerk: e,
            component: t,
            fallback: n,
            ...r
            ...
            return i.default.createElement(i.default.Fragment, null, o && n, i.default.createElement(A, {
                component: t,
    ...
    function M({
        ...
        return l(r.userButtonMenuItemsRenderedError), i.default.createElement(i.default.Fragment, null, e)
    }

    function W({
        children: e
    }) {
        return l(r.userButtonMenuActionRenderedError), i.default.createElement(i.default.Fragment, null, e)
    }

    function F({
        children: e
    }) {
        return l(r.userButtonMenuLinkRenderedError), i.default.createElement(i.default.Fragment, null, e)
    }
    var B = Object.assign((0, r.withClerk)(({
        clerk: e,
        component: t,
        fallback: n,
        ...o
        ...
        let u = "rendering" === _(t) || !e.loaded,
            ...
            },
            {
                ...
                MenuLinkComponent: o,
                UserProfileLinkComponent: a,
                UserProfilePageComponent: u,
                reorderItemsLabels: s,
                allowForAnyChildren: d = !1
            }) => {
                let m = [],
                    f = [],
                    h = [];
                    ...
                    i.default.Children.forEach(p.children, e => {
                        ...
                        if (c(e, n))
                            if (k(t, s)) m.push({
                                ...
                                if (!y(t)) return void l(r.userButtonMenuItemsActionWrongsProps);
                                let e = {
                                    label: i,
                                    labelIcon: a
                                };
                                if (void 0 !== d) m.push({ ...e,
                                    onClick: d
                                });
                                else {
                                    if (void 0 === p) return void l("Custom menu item must have either onClick or open property");
                                    m.push({ ...e,
                        ...
                        if (c(e, o))
                            if (!E(t)) return void l(r.userButtonMenuItemLinkWrongProps);
                            else m.push({
                                label: i,
                                labelIcon: a,
                                href: u
                ...
                return m.forEach((e, t) => {
                    if (k(e, s) && f.push({
                        ...
                        "onClick" in e ? l.onClick = e.onClick : "open" in e && (l.open = e.open), f.push(l), h.push(n)
                    }
                    if (E(e)) {
                        let {
                            portal: n,
                ...
                MenuItemsComponent: M,
                MenuActionComponent: W,
                MenuLinkComponent: F,
                UserProfileLinkComponent: L,
                UserProfilePageComponent: T,
        ...
        return i.default.createElement(R.Provider, {
            value: b
        }, u && n, e.loaded && i.default.createElement(A, {
            component: t,
            ...b,
            hideRootHtmlElement: !!o.__experimental_asProvider,
            rootProps: s
        }, o.__experimental_asProvider ? C : null, i.default.createElement(I, {
            customPagesPortals: f,
            customMenuItemsPortals: v
        })))
    }, {
        ...
        __experimental_Outlet: function(e) {
            ...
            return i.default.createElement(A, { ...n
            })
        }
    });
    ...
    function z({
        ...
        return l(r.organizationProfilePageRenderedError), i.default.createElement(i.default.Fragment, null, e)
    }

    function x({
        children: e
    }) {
        return l(r.organizationProfileLinkRenderedError), i.default.createElement(i.default.Fragment, null, e)
    }
    var N = Object.assign((0, r.withClerk)(({
            clerk: e,
            component: t,
            fallback: n,
            ...r
        ...
        j = Object.assign((0, r.withClerk)(({
            ...
            return e.__experimental_prefetchOrganizationSwitcher(), i.default.createElement(D.Provider, {
                value: p
            }, i.default.createElement(i.default.Fragment, null, o && n, e.loaded && i.default.createElement(A, { ...p,
                hideRootHtmlElement: !!r.__experimental_asProvider
            }, r.__experimental_asProvider ? d : null, i.default.createElement(I, {
                customPagesPortals: u
            }))))
        }, {
            ...
            OrganizationProfilePage: z,
            OrganizationProfileLink: x,
            __experimental_Outlet: function(e) {
    ...
    e.s(["APIKeys", 0, X, "CreateOrganization", 0, $, "GoogleOneTap", 0, K, "OrganizationList", 0, G, "OrganizationProfile", 0, N, "OrganizationSwitcher", 0, j, "PricingTable", 0, q, "SignIn", 0, S, "SignUp", 0, U, "TaskChooseOrganization", 0, H, "TaskResetPassword", 0, Z, "TaskSetupMFA", 0, J, "UserAvatar", 0, Y, "UserButton", 0, B, "UserProfile", 0, O, "Waitlist", 0, V, "assertSingleChild", 0, e => t => {
        try {
            return i.default.Children.only(e)
        } catch {
            return r.errorThrower.throw((0, r.multipleChildrenInButtonComponent)(t))
        }
    }, "isConstructor", 0, function(e) {
        return "function" == typeof e
    }, "normalizeWithDefaultValue", 0, (e, t) => (e || (e = t), "string" == typeof e && (e = i.default.createElement("button", null, e)), e), "safeExecute", 0, e => (...t) => {
        ...
        let o = e.displayName || e.name || t || "Component",
            ...
            }(t, n), i.default.createElement(e, { ...o
            }));
        return l.displayName = `withMaxAllowedInstancesGuard(${o})`, l
    }], 33917)
}, 41383, e => {
    "use strict";
    ...
    e.s(["camelToSnake", 0, r, "deepCamelToSnake", 0, l, "deepSnakeToCamel", 0, i, "getNonUndefinedValues", 0, function(e) {
        return Object.entries(e).reduce((e, [t, n]) => (void 0 !== n && (e[t] = n), e), {})
    ...
    function l(e = "") {
        try {
            if (!(e.startsWith(r) || e.startsWith("pk_test_"))) return !1;
            let t = e.split("_");
        ...
        return {
            isDevOrStagingUrl: n => {
                ...
                let r = "string" == typeof n ? n : n.hostname,
                    o = e.get(r);
                return void 0 === o && (o = t.some(e => r.endsWith(e)), e.set(r, o)), o
            }
        }
    ...
    var o = e.i(71645),
        l = e.i(27085),
        i = (0, t.buildErrorThrower)({
            packageName: "@clerk/clerk-react"
        }),
        [a, u] = (0, l.createContextAndHook)("AuthContext"),
        s = l.ClerkInstanceContext,
        d = l.useClerkInstanceContext,
        p = e => {
            (0, l.useAssertWrappedByClerkProvider)(() => {
        ...
        c = e => new Promise(t => {
            let n = r => {
                ["ready", "degraded"].includes(r) && (t(), e.off("status", n))
            };
            e.on("status", n, {
                notify: !0
            })
    ...
    function m(e, {
        ...
        let {
            ...
            sessionClaims: f
        } = null != e ? e : {}, h = (0, o.useCallback)(e => u ? u(e) : (0, n.createCheckAuthorization)({
            userId: r,
            orgId: l,
            orgRole: a,
            orgPermissions: p,
        ...
        })(e), [u, r, l, a, p, c, f]), g = (0, n.resolveAuthState)({
            authObject: { ...e,
                getToken: d,
                signOut: s,
                has: h
    ...
    e.s(["AuthContext", 0, a, "IsomorphicClerkContext", 0, s, "customLinkWrongProps", 0, e => `Missing props. <${e}.Link /> component requires the following props: url, label and labelIcon.`, "customMenuItemsIgnoredComponent", 0, "<UserButton.MenuItems /> component can only accept <UserButton.Action /> and <UserButton.Link /> as its children. Any other provided component will be ignored. Additionally, please ensure that the component is rendered in a client component.", "customPageWrongProps", 0, e => `Missing props. <${e}.Page /> component requires the following props: url, label, labelIcon, alongside with children to be rendered inside the page.`, "customPagesIgnoredComponent", 0, e => `<${e} /> can only accept <${e}.Page /> and <${e}.Link /> as its children. Any other provided component will be ignored. Additionally, please ensure that the component is rendered in a client component.`, "errorThrower", 0, i, "incompatibleRoutingWithPathProvidedError", 0, e => `The \`path\` prop will only be respected when the Clerk component uses path-based routing. To resolve this error, pass \`routing='path'\` to the <${e}/> component, or drop the \`path\` prop to switch to hash-based routing. For more details please refer to our docs: https://clerk.com/docs`, "multipleChildrenInButtonComponent", 0, e => `You've passed multiple children components to <${e}/>. You can only pass a single child component or text.`, "multipleClerkProvidersError", 0, "You've added multiple <ClerkProvider> components in your React component tree. Wrap your components in a single <ClerkProvider>.", "noPathProvidedError", 0, e => `The <${e}/> component uses path-based routing by default unless a different routing strategy is provided using the \`routing\` prop. When path-based routing is used, you need to provide the path where the component is mounted on by using the \`path\` prop. Example: <${e} path={'/my-path'} />`, "organizationProfileLinkRenderedError", 0, "<OrganizationProfile.Link /> component needs to be a direct child of `<OrganizationProfile />` or `<OrganizationSwitcher />`.", "organizationProfilePageRenderedError", 0, "<OrganizationProfile.Page /> component needs to be a direct child of `<OrganizationProfile />` or `<OrganizationSwitcher />`.", "setErrorThrowerOptions", 0, function(e) {
        ...
        let a = d(),
            s = (0, o.useCallback)(async e => (await c(a), a.session) ? a.session.getToken(e) : null, [a]),
            f = (0, o.useCallback)(async (...e) => (await c(a), a.signOut(...e)), [a]);
        return null == (t = a.telemetry) || t.record((0, r.eventMethodCalled)("useAuth", {
            treatPendingAsSignedOut: n
        })), m({ ...i,
            getToken: s,
            signOut: f
        ...
        } = o.default.useMemo(() => e.createEmailLinkFlow(), [e]);
        ...
        p("useSignIn");
        let t = d(),
            n = (0, l.useClientContext)();
        return (null == (e = t.telemetry) || e.record((0, r.eventMethodCalled)("useSignIn")), n) ? {
            isLoaded: !0,
            signIn: n.signIn,
        ...
        let t = d(),
            n = (0, l.useClientContext)();
        return (null == (e = t.telemetry) || e.record((0, r.eventMethodCalled)("useSignUp")), n) ? {
            isLoaded: !0,
            signUp: n.signUp,
            setActive: t.setActive
        } : {
        ...
        let r = "string" == typeof t ? void 0 : t,
            l = t => {
                p(n || "withClerk");
                let l = d();
                return l.loaded || (null == r ? void 0 : r.renderWhileLoading) ? o.default.createElement(e, { ...t,
                    component: n,
                    clerk: l
                }) : null
            };
        return l.displayName = `withClerk(${n})`, l
    }], 65389)
}, 65829, e => {
    "use strict";
    var t = e.i(65389),
    ...
    let r = new Set,
        o = (e, t, o) => {
            let l = (0, n.isTestEnvironment)() || (0, n.isProductionEnvironment)(),
                i = o ? ? e;
            r.has(i) || l || (r.add(i), console.warn(`Clerk - DEPRECATION WARNING: "${e}" is deprecated and will be removed in the next major release.
${t}`))
        };
    var l = e.i(71645),
        i = e.i(27085),
        a = (0, t.withClerk)(({
            ...
            let {
                client: n,
                session: r
            } = e, o = n.signedInSessions ? n.signedInSessions.length > 0 : n.activeSessions && n.activeSessions.length > 0;
        ...
        d = (0, t.withClerk)(({
            ...
            o("RedirectToUserProfile", "Use the `redirectToUserProfile()` method instead."), e.redirectToUserProfile()
        }, []), null), "RedirectToUserProfile"),
        p = (0, t.withClerk)(({
            clerk: e
        }) => (l.default.useEffect(() => {
            o("RedirectToOrganizationProfile", "Use the `redirectToOrganizationProfile()` method instead."), e.redirectToOrganizationProfile()
        }, []), null), "RedirectToOrganizationProfile"),
        c = (0, t.withClerk)(({
            clerk: e
        }) => (l.default.useEffect(() => {
            o("RedirectToCreateOrganization", "Use the `redirectToCreateOrganization()` method instead."), e.redirectToCreateOrganization()
    ...
    e.s(["AuthenticateWithRedirectCallback", 0, m, "ClerkDegraded", 0, ({
        children: e
    }) => ((0, t.useAssertWrappedByClerkProvider)("ClerkDegraded"), "degraded" !== (0, t.useIsomorphicClerkContext)().status) ? null : e, "ClerkFailed", 0, ({
        children: e
    }) => ((0, t.useAssertWrappedByClerkProvider)("ClerkFailed"), "error" !== (0, t.useIsomorphicClerkContext)().status) ? null : e, "ClerkLoaded", 0, ({
        children: e
    }) => ((0, t.useAssertWrappedByClerkProvider)("ClerkLoaded"), (0, t.useIsomorphicClerkContext)().loaded) ? e : null, "ClerkLoading", 0, ({
        children: e
    }) => ((0, t.useAssertWrappedByClerkProvider)("ClerkLoading"), "loading" !== (0, t.useIsomorphicClerkContext)().status) ? null : e, "MultisessionAppSupport", 0, ({
        children: e
    }) => {
        (0, t.useAssertWrappedByClerkProvider)("MultisessionAppSupport");
        let n = (0, i.useSessionContext)();
        ...
        (0, t.useAssertWrappedByClerkProvider)("Protect");
        let {
            isLoaded: l,
            has: i,
            userId: a
        ...
        if (!l) return null;
        let u = null != n ? n : null;
        return a ? "function" == typeof o.condition ? o.condition(i) ? e : u : o.role || o.permission || o.feature || o.plan ? i(o) ? e : u : e : u
    }, "RedirectToCreateOrganization", 0, c, "RedirectToOrganizationProfile", 0, p, "RedirectToSignIn", 0, a, "RedirectToSignUp", 0, u, "RedirectToTasks", 0, s, "RedirectToUserProfile", 0, d, "SignedIn", 0, ({
        children: e,
        treatPendingAsSignedOut: n
    }) => {
        (0, t.useAssertWrappedByClerkProvider)("SignedIn");
        let {
            userId: r
        } = (0, t.useAuth)({
            treatPendingAsSignedOut: n
        ...
        (0, t.useAssertWrappedByClerkProvider)("SignedOut");
        let {
            userId: r
        } = (0, t.useAuth)({
            treatPendingAsSignedOut: n
